function X2JS(a,b,c) {
        ...
        if (f.nodeType == u.ELEMENT_NODE) {
            ...
            for (var n = f.childNodes,
                ...
                var l = n.item( o ),
                    m = d( l );
                if (i.__cnt++,null == i[m])
                    i[m] = h( l ),i[m + "_asArray"] = new Array( 1 ),i[m + "_asArray"][0] = i[m];
                else {
    ...
    function n(a) {
        ...
        if (a instanceof Object)
            for (var c in a)
                -1 == c.toString().indexOf( "__" ) && 0 == c.toString().indexOf( "_" ) && b.push( c );
        return b
    }
    function o(a) {
        var b = "";
    ...
    this.parseXmlString = function (a) {
        ...
        if (window.DOMParser) {
            ...
            0 == a.indexOf( "<?" ) && (a = a.substr( a.indexOf( "?>" ) + 2 )),b = new ActiveXObject( "Microsoft.XMLDOM" ),b.async = "false",b.loadXML( a );
        return b
...
function ObjectIron(a) {
    var b;
    for (b = [],i = 0,len = a.length;
        len > i;
        i += 1)
        b.push( a[i].isRoot ? "root" : a[i].name );
    var c = function (a,b) {
        var c;
        if (null !== a && null !== b)
            for (c in a)
        ...
        d = function (a,b,d) {
            ...
            if (null !== a && 0 !== a.length)
                for (e = 0,f = a.length;
                    f > e;
                    e += 1)
                    g = a[e],b.hasOwnProperty( g.name ) && (d.hasOwnProperty( g.name ) ? g.merge && (h = b[g.name],i = d[g.name],"object" == typeof h && "object" == typeof i ? c( h,i ) : d[g.name] = null != g.mergeFunction ? g.mergeFunction( h,i ) : h + i) : d[g.name] = b[g.name])
        },
        e = function (a,b) {
            var c,
                f,
            ...
            if (null !== l.children && 0 !== l.children.length)
                for (c = 0,f = l.children.length;
                    f > c;
                    c += 1)
                    if (j = l.children[c],b.hasOwnProperty( j.name ))
                        if (j.isArray)
                            for (i = b[j.name + "_asArray"],g = 0,h = i.length;
                                h > g;
                                g += 1)
                                k = i[g],d( l.properties,b,k ),e( j,k );
                        else
                            k = b[j.name],d( l.properties,b,k ),e( j,k )
        },
        f = function (c) {
            var d,
                g,
            ...
            for (i in c)
                if (c.hasOwnProperty( i )) {
                    if (h = b.indexOf( i ),-1 !== h)
                        if (j = a[h],j.isArray)
                            for (l = c[i + "_asArray"],d = 0,g = l.length;
                                g > d;
                                d += 1)
                                k = l[d],e( j,k );
                        else
...
MediaPlayer = function (a) {
    ...
    var b,
        ...
        q = !0,
        r = !1,
        s = MediaPlayer.dependencies.BufferController.BUFFER_SIZE_REQUIRED,
        t = function () {
            return!!e && !!f
        },
        u = function () {
            ...
            if (!this.capabilities.supportsMediaSource())
                return void this.errHandler.capabilityError( "mediasource" );
            if (!e || !f)
                throw"Missing view or source.";
            p = !0,g = b.getObject( "streamController" ),g.subscribe( g.eventList.ENAME_STREAMS_COMPOSED,i ),c.subscribe( c.eventList.ENAME_MANIFEST_LOADED,g ),c.subscribe( c.eventList.ENAME_MANIFEST_LOADED,i ),g.setVideoModel( l ),g.setAutoPlay( q ),g.load( f ),b.mapValue( "scheduleWhilePaused",r ),b.mapOutlet( "scheduleWhilePaused","stream" ),b.mapOutlet( "scheduleWhilePaused","scheduleController" ),b.mapValue( "bufferMax",s ),b.mapOutlet( "bufferMax","bufferController" ),h.initialize()
        },
        v = function () {
            t() && u.call( this )
        },
        ...
        x = function () {
            return w.call( this ).manifestInfo.DVRWindowSize
        },
        y = function (a) {
            var b = w.call( this ),
                c = b.range.start + a;
        ...
        z = function (a) {
            l.getElement().currentTime = this.getDVRSeekOffset( a )
        },
        A = function () {
            var a = w.call( this );
            return null === a ? 0 : this.duration() - (a.range.end - a.time)
        },
        B = function () {
            var a,
                b = w.call( this );
            return null === b ? 0 : (a = b.range.end - b.range.start,a < b.manifestInfo.DVRWindowSize ? a : b.manifestInfo.DVRWindowSize)
        },
        C = function () {
            var a,
                b,
                c = w.call( this );
            return null === c ? 0 : (a = c.manifestInfo.availableFrom.getTime() / 1e3,b = this.time() + (a + c.range.start))
        },
        D = function () {
            var a,
                b,
                c = w.call( this );
            return null === c ? 0 : (a = c.manifestInfo.availableFrom.getTime() / 1e3,b = a + c.range.start + this.duration())
        },
        E = function (a,b,c) {
        ...
        H = function () {
            p && g && (g.unsubscribe( g.eventList.ENAME_STREAMS_COMPOSED,i ),c.unsubscribe( c.eventList.ENAME_MANIFEST_LOADED,g ),c.unsubscribe( c.eventList.ENAME_MANIFEST_LOADED,i ),g.reset(),d.reset(),h.reset(),g = null,p = !1)
        };
    return b = new dijon.System,b.mapValue( "system",b ),b.mapOutlet( "system" ),b.injectInto( n ),{
        notifier : void 0,
        debug : void 0,
        eventBus : void 0,
        capabilities : void 0,
        ...
        setup : function () {
            j = b.getObject( "metricsExt" ),c = b.getObject( "manifestLoader" ),i = b.getObject( "manifestUpdater" ),d = b.getObject( "abrController" ),h = b.getObject( "rulesController" ),k = b.getObject( "metricsModel" )
        },
        ...
        getQualityFor : function (a) {
            return d.getQualityFor( a )
        },
        setQualityFor : function (a,b) {
            d.setPlaybackQuality( a,b )
        },
        getAutoSwitchQuality : function () {
            return d.getAutoSwitchBitrate()
        },
        setAutoSwitchQuality : function (a) {
            d.setAutoSwitchBitrate( a )
        },
        setSchedulingRules : function (a) {
            G.call( this,h.SCHEDULING_RULE,a,!0 )
        },
        addSchedulingRules : function (a) {
            G.call( this,h.SCHEDULING_RULE,a,!1 )
        },
        setABRRules : function (a) {
            G.call( this,h.ABR_RULE,a,!0 )
        },
        addABRRules : function (a) {
            G.call( this,h.ABR_RULE,a,!1 )
        },
        attachView : function (a) {
            if (!o)
                throw"MediaPlayer not initialized!";
            e = a,l = null,e && (l = b.getObject( "videoModel" ),l.setElement( e )),H.call( this ),t.call( this ) && v.call( this )
        },
        attachSource : function (a) {
            if (!o)
                throw"MediaPlayer not initialized!";
            this.uriQueryFragModel.reset(),f = this.uriQueryFragModel.parseURI( a ),H.call( this ),t.call( this ) && v.call( this )
        },
        reset : function () {
...
MediaPlayer.dependencies = {},MediaPlayer.utils = {},MediaPlayer.models = {},MediaPlayer.vo = {},MediaPlayer.vo.metrics = {},MediaPlayer.rules = {},MediaPlayer.di = {},MediaPlayer.di.Context = function () {
    ...
    return{
        system : void 0,
        setup : function () {
            Dash.di.DashContext.prototype.setup.call( this ),this.system.mapClass( "parser",Dash.dependencies.DashParser ),this.system.mapClass( "indexHandler",Dash.dependencies.DashHandler ),this.system.mapSingleton( "baseURLExt",Dash.dependencies.BaseURLExtensions ),this.system.mapClass( "fragmentExt",Dash.dependencies.FragmentExtensions ),this.system.mapClass( "trackController",Dash.dependencies.RepresentationController ),this.system.mapSingleton( "manifestExt",Dash.dependencies.DashManifestExtensions ),this.system.mapSingleton( "metricsExt",Dash.dependencies.DashMetricsExtensions ),this.system.mapSingleton( "timelineConverter",Dash.dependencies.TimelineConverter ),this.system.mapSingleton( "adapter",Dash.dependencies.DashAdapter )
        }
    }
},Dash.di.DashContext.prototype = new MediaPlayer.di.Context,Dash.di.DashContext.prototype.constructor = Dash.di.DashContext,function (a) {
    "use strict";
    var b = {
        VERSION : "0.5.3"
    };
    b.System = function () {
        ...
        mapHandler : function (a,b,c,d,e) {
            ...
            return b = b || "global",c = c || a,"undefined" == typeof d && (d = !1),"undefined" == typeof e && (e = !1),this._handlers.hasOwnProperty( a ) || (this._handlers[a] = {}),this._handlers[a].hasOwnProperty( b ) || (this._handlers[a][b] = [
            ]),this._handlers[a][b].push( {
                handler : c,
                oneShot : d,
                passEvent : e
            } ),this
    ...
    a.dijon = b
}( this ),Dash.dependencies.BaseURLExtensions = function () {
    "use strict";
    var a = function (a,b) {
        for (var c,
            d,
        ...
        for (n.version = m.getUint8(o + 8),o += 12,n.timescale = m.getUint32(o + 4,!1),o += 8,0 === n.version?(n.earliest_presentation_time = m.getUint32(o,!1),n.first_offset = m.getUint32(o + 4,!1),o += 8):(n.earliest_presentation_time = utils.Math.to64BitNumber(m.getUint32(o + 4,!1),m.getUint32(o,!1)),n.first_offset = (m.getUint32(o + 8,!1) << 32) + m.getUint32(o + 12,!1),o += 16),n.first_offset += e + (b || 0),n.reference_count = m.getUint16(o + 2,!1),o += 4,n.references = [],c = n.first_offset,d = n.earliest_presentation_time,f = 0;
            f < n.reference_count;
            f += 1)
            h = m.getUint32( o,!1 ),g = h >>> 31,h = 2147483647 & h,i = m.getUint32( o + 4,!1 ),o += 12,n.references.push( {
                size : h,
                type : g,
                offset : c,
                duration : i,
        ...
        b = function (b,c,d) {
            var e,
                ...
                k,
                l;
            for (e = a.call(this,b,d),f = e.references,g = [],i = 0,j = f.length;
                j > i;
                i += 1)
                h = new Dash.vo.Segment,h.duration = f[i].duration,h.media = c,h.startTime = f[i].time,h.timescale = f[i].timescale,k = f[i].offset,l = f[i].offset + f[i].size - 1,h.mediaRange = k + "-" + l,g.push( h );
            return this.debug.log( "Parsed SIDX box: " + g.length + " segments." ),g
        },
        c = function (a,b,d) {
            var e,
                f,
            ...
            for (s.debug.log( "Searching for initialization." );
                ...
                for (q = n.getUint32(o),o += 4,p = "",j = 0;
                    4 > j;
                    j += 1)
                    k = n.getInt8( o ),p += String.fromCharCode( k ),o += 1;
                "ftyp" === p && (e = o - 8),"moov" === p && (f = o - 8),"moov" !== p && (o += q - 8)
            }
            i = n.byteLength - o,"moov" !== p ? (s.debug.log( "Loading more bytes to find initialization." ),b.range.start = 0,b.range.end = b.bytesLoaded + b.bytesToLoad,l = new XMLHttpRequest,l.onloadend = function () {
                r || d.call( s,null,new Error( "Error loading initialization." ) )
            },l.onload = function () {
                r = !0,b.bytesLoaded = b.range.end,c.call( s,l.response,function (a) {
                    d.call( s,a )
                } )
            },l.onerror = function () {
                d.call( s,null,new Error( "Error loading initialization." ) )
            },l.open( "GET",s.tokenAuthentication.addTokenAsQueryArg( b.url ) ),l.responseType = "arraybuffer",l.setRequestHeader( "Range","bytes=" + b.range.start + "-" + b.range.end ),l = s.tokenAuthentication.setTokenInRequestHeader( l ),l.send( null )) : (g = void 0 === e ? f : e,h = f + q - 1,m = g + "-" + h,s.debug.log( "Found the initialization.  Range: " + m ),d.call( s,m ))
        },
        d = function (a) {
            var b = new XMLHttpRequest,
                d = !0,
                e = this,
                f = a.adaptation.period.mpd.manifest.Period_asArray[a.adaptation.period.index].AdaptationSet_asArray[a.adaptation.index].Representation_asArray[a.index].BaseURL,
                g = {
                    url : f,
                    range : {},
                    searching : !1,
            ...
            e.debug.log( "Start searching for initialization." ),g.range.start = 0,g.range.end = g.bytesToLoad,b.onload = function () {
                b.status < 200 || b.status > 299 || (d = !1,g.bytesLoaded = g.range.end,c.call( e,b.response,g,function (b) {
                    a.range = b,a.initialization = f,e.notify( e.eventList.ENAME_INITIALIZATION_LOADED,a )
                } ))
            },b.onloadend = b.onerror = function () {
                d && (d = !1,e.errHandler.downloadError( "initialization",g.url,b ),e.notify( e.eventList.ENAME_INITIALIZATION_LOADED,a ))
            },b.open( "GET",e.tokenAuthentication.addTokenAsQueryArg( g.url ) ),b.responseType = "arraybuffer",b.setRequestHeader( "Range","bytes=" + g.range.start + "-" + g.range.end ),b = e.tokenAuthentication.setTokenInRequestHeader( b ),b.send( null ),e.debug.log( "Perform init search: " + g.url )
        },
        e = function (a,c,d,g) {
            var h,
                i,
                ...
                w = !1,
                x = this;
            for (x.debug.log( "Searching for SIDX box." ),x.debug.log( c.bytesLoaded + " bytes loaded." );
                "sidx" !== t && s < q.byteLength;) {
                for (u = q.getUint32(s),s += 4,t = "",m = 0;
                    4 > m;
                    m += 1)
                    n = q.getInt8( s ),t += String.fromCharCode( n ),s += 1;
                "sidx" !== t && (s += u - 8)
            }
            if (i = q.byteLength - s,"sidx" !== t)
                g.call( x );
            else if (u - 8 > i)
                x.debug.log( "Found SIDX but we don't have all of it." ),c.range.start = 0,c.range.end = c.bytesLoaded + (u - i),r.onload = function () {
                    r.status < 200 || r.status > 299 || (v = !1,c.bytesLoaded = c.range.end,e.call( x,r.response,c,d,g ))
                },r.onloadend = r.onerror = function () {
                    v && (v = !1,x.errHandler.downloadError( "SIDX",c.url,r ),g.call( x ))
                },r.open( "GET",x.tokenAuthentication.addTokenAsQueryArg( c.url ) ),r.responseType = "arraybuffer",r.setRequestHeader( "Range","bytes=" + c.range.start + "-" + c.range.end ),r = x.tokenAuthentication.setTokenInRequestHeader( r ),r.send( null );
            else if (c.range.start = s - 8,c.range.end = c.range.start + u,x.debug.log( "Found the SIDX box.  Start: " + c.range.start + " | End: " + c.range.end ),j = new ArrayBuffer( c.range.end - c.range.start ),l = new Uint8Array( j ),k = new Uint8Array( a,c.range.start,c.range.end - c.range.start ),l.set( k ),o = this.parseSIDX.call( this,j,c.range.start ),p = o.references,null !== p && void 0 !== p && p.length > 0 && (w = 1 === p[0].type),w) {
                x.debug.log( "Initiate multiple SIDX load." );
                var y,
                    z,
                    A,
                    B,
                    ...
                    E = 0,
                    F = function (a) {
                        a ? (D = D.concat( a ),E += 1,E >= z && g.call( x,D )) : g.call( x )
                    };
                for (y = 0,z = p.length;
                    z > y;
                    y += 1)
                    A = p[y].offset,B = p[y].offset + p[y].size - 1,C = A + "-" + B,f.call( x,d,null,C,F )
            }else
                x.debug.log( "Parsing segments from SIDX." ),h = b.call( x,j,c.url,c.range.start ),g.call( x,h )
        },
        f = function (a,c,d,f) {
            var g,
                h,
                i = new XMLHttpRequest,
                j = a.adaptation.period.mpd.manifest.Period_asArray[a.adaptation.period.index].AdaptationSet_asArray[a.adaptation.index].Representation_asArray[a.index].BaseURL,
                k = !0,
                l = this,
                m = {
                    url : j,
            ...
            null === d ? (l.debug.log( "No known range for SIDX request." ),m.searching = !0,m.range.start = 0,m.range.end = m.bytesToLoad) : (h = d.split( "-" ),m.range.start = parseFloat( h[0] ),m.range.end = parseFloat( h[1] )),i.onload = function () {
                i.status < 200 || i.status > 299 || (k = !1,m.searching ? (m.bytesLoaded = m.range.end,e.call( l,i.response,m,a,function (b) {
                    b && f.call( l,b,a,c )
                } )) : (g = b.call( l,i.response,m.url,m.range.start ),f.call( l,g,a,c )))
            },i.onloadend = i.onerror = function () {
                k && (k = !1,l.errHandler.downloadError( "SIDX",m.url,i ),f.call( l,null,a,c ))
            },i.open( "GET",l.tokenAuthentication.addTokenAsQueryArg( m.url ) ),i.responseType = "arraybuffer",i.setRequestHeader( "Range","bytes=" + m.range.start + "-" + m.range.end ),i = l.tokenAuthentication.setTokenInRequestHeader( i ),i.send( null ),l.debug.log( "Perform SIDX load: " + m.url )
        },
        g = function (a,b,c) {
            var d = this;
            a ? d.notify( d.eventList.ENAME_SEGMENTS_LOADED,a,b,c ) : d.notify( d.eventList.ENAME_SEGMENTS_LOADED,null,b,c,new Error( "error loading segments" ) )
        };
    return{
        debug : void 0,
        errHandler : void 0,
...
Dash.dependencies.DashAdapter = function () {
    ...
    var a = [
        ...
        f = function (a) {
            var b = new MediaPlayer.vo.TrackInfo,
                c = a.adaptation.period.mpd.manifest.Period_asArray[a.adaptation.period.index].AdaptationSet_asArray[a.adaptation.index],
                d = this.manifestExt.getRepresentationFor( a.index,c );
            return b.id = a.id,b.quality = a.index,b.bandwidth = this.manifestExt.getBandwidth( d ),b.DVRWindow = a.segmentAvailabilityRange,b.fragmentDuration = a.segmentDuration || (a.segments && a.segments.length > 0 ? a.segments[0].duration : 0 / 0),b.MSETimeOffset = a.MSETimeOffset,b.useCalculatedLiveEdgeTime = a.useCalculatedLiveEdgeTime,b.mediaInfo = g.call( this,a.adaptation ),b
        },
        g = function (a) {
            var b = new MediaPlayer.vo.MediaInfo,
                c = this,
                d = a.period.mpd.manifest.Period_asArray[a.period.index].AdaptationSet_asArray[a.index];
            return b.id = a.id,b.index = a.index,b.type = a.type,b.streamInfo = h.call( this,a.period ),b.trackCount = this.manifestExt.getRepresentationCount( d ),b.lang = this.manifestExt.getLanguageForAdaptation( d ),b.codec = this.manifestExt.getCodec( d ),b.mimeType = this.manifestExt.getMimeType( d ),b.contentProtection = this.manifestExt.getContentProtectionData( d ),b.contentProtection && b.contentProtection.forEach( function (a) {
                a.KID = c.manifestExt.getKID( a )
            } ),b.isText = this.manifestExt.getIsTextTrack( b.mimeType ),b
        },
        h = function (a) {
            var b = new MediaPlayer.vo.StreamInfo;
            return b.id = a.id,b.index = a.index,b.start = a.start,b.duration = a.duration,b.manifestInfo = i.call( this,a.mpd ),b
        },
        i = function (a) {
            var b = new MediaPlayer.vo.ManifestInfo,
                c = this.manifestModel.getValue();
            return b.DVRWindowSize = a.timeShiftBufferDepth,b.loadedTime = a.manifest.loadedTime,b.availableFrom = a.availabilityStartTime,b.minBufferTime = a.manifest.minBufferTime,b.maxFragmentDuration = a.maxSegmentDuration,b.duration = this.manifestExt.getDuration( c ),b.isDynamic = this.manifestExt.getIsDynamic( c ),b
        },
        j = function (a,c,d) {
            var f,
                h = e( c ),
            ...
            return j ? (f = this.manifestExt.getIndexForAdaptation( j,a,c.index ),b[i] = b[i] || this.manifestExt.getAdaptationsForPeriod( a,h ),g.call( this,b[i][f] )) : null
        },
        k = function (c) {
            var d,
                e,
            ...
            if (!c)
                return null;
            for (d = this.manifestExt.getMpd(c),a = this.manifestExt.getRegularPeriods(c,d),b = {},e = a.length,f = 0;
                e > f;
                f += 1)
                g.push( h.call( this,a[f] ) );
            return g
        },
        l = function (a) {
        ...
        m = function (a,b) {
            var c = a.trackController.getRepresentationForQuality( b );
            return a.indexHandler.getInitRequest( c )
        },
        n = function (a,b) {
            var d = c( b,a.trackController );
            return a.indexHandler.getNextSegmentRequest( d )
        },
        o = function (a,b,d,e) {
            var f = c( b,a.trackController );
            return a.indexHandler.getSegmentRequestForTime( f,d,e )
        },
        p = function (a,b,d) {
            var e = c( b,a.trackController ),
                f = a.indexHandler.generateSegmentRequestForTime( e,d );
            return f
        },
        q = function (a) {
        ...
        s = function (a) {
            var b,
                ...
                j = a.getType();
            b = g.id,c = b ? this.manifestExt.getAdaptationForId( b,i,f.index ) : this.manifestExt.getAdaptationForIndex( g.index,i,f.index ),a.setMediaInfo( g ),a.trackController.updateData( c,h,j )
        },
        t = function (a,b) {
            var c = a.getRepresentationForQuality( b );
            return c ? f.call( this,c ) : null
        },
        u = function (a) {
            var b = a.getCurrentRepresentation();
            return b ? f.call( this,b ) : null
        },
        v = function (a,b,c) {
        ...
        w = function (a,b) {
            var f = this.manifestModel.getValue(),
                g = [
                ];
            return a instanceof MediaPlayer.vo.StreamInfo ? g = this.manifestExt.getEventsForPeriod( f,e( a ) ) : a instanceof MediaPlayer.vo.MediaInfo ? g = this.manifestExt.getEventStreamForAdaptationSet( f,d( a ) ) : a instanceof MediaPlayer.vo.TrackInfo && (g = this.manifestExt.getEventStreamForRepresentation( f,c( a,b.trackController ) )),g
        };
    return{
        system : void 0,
        manifestExt : void 0,
        ...
        getCurrentTrackInfo : u,
        getTrackInfoForQuality : t,
        updateData : s,
        getInitRequest : m,
        getNextFragmentRequest : n,
        getFragmentRequestForTime : o,
        generateFragmentRequestForTime : p,
        getIndexHandlerTime : q,
        setIndexHandlerTime : r,
        getEventsFor : w,
        getEvent : v,
        reset : function () {
            a = [
    ...
    var a,
        ...
        g = function (a,b,c) {
            for (var d,
                ...
                l = "%0",
                m = l.length;;) {
                if (i = a.indexOf( "$" + b ),0 > i)
                    return a;
                if (j = a.indexOf( "$",i + k ),0 > j)
                    return a;
                if (d = a.indexOf( l,i + k ),d > i && j > d)
                    switch (e = a.charAt( j - 1 ),g = parseInt( a.substring( d + m,j - 1 ),10 ),e) {
                        case"d":
                        case"i":
                        case"u":
                            h = f( c.toString(),g );
        ...
        i = function (a,b) {
            if (null === b || -1 === a.indexOf( "$RepresentationID$" ))
                return a;
            var c = b.toString();
        ...
        k = function (a,b) {
            var c,
                d = b.adaptation.period.mpd.manifest.Period_asArray[b.adaptation.period.index].AdaptationSet_asArray[b.adaptation.index].Representation_asArray[b.index].BaseURL;
        ...
        l = function (a,c) {
            ...
            return d = a.adaptation.period,g.mediaType = c,g.type = "Initialization Segment",g.url = k( a.initialization,a ),g.range = a.range,e = d.start,g.availabilityStartTime = f.timelineConverter.calcAvailabilityStartTimeFromPresentationTime( e,a.adaptation.period.mpd,b ),g.availabilityEndTime = f.timelineConverter.calcAvailabilityEndTimeFromPresentationTime( e + d.duration,d.mpd,b ),g.quality = a.index,g
        },
        m = function (a) {
            var b,
                d = this;
            return a ? b = l.call( d,a,c ) : null
        },
        n = function (a) {
            var c,
                e,
                f,
                g = a.adaptation.period,
                h = !1;
            return b ? h = !1 : 0 > d ? h = !1 : d < a.availableSegmentsNumber ? (e = A( d,a ),e && (f = e.presentationStartTime - g.start,c = a.adaptation.period.duration,this.debug.log( a.segmentInfoType + ": " + f + " / " + c ),h = f >= c)) : h = !0,h
        },
        o = function (a,c) {
            var d,
                e,
        ...
        p = function (b) {
            var c,
                ...
                A = -1,
                B = function (a) {
                    return t.call( q,b,y,a.d,p,r.media,a.mediaRange,A )
                };
            for (p = b.timescale,c = u.S_asArray,k = s.call(q,b),k?(n = k.start,o = k.end):m = q.timelineConverter.calcMediaTimeFromPresentationTime(a || 0,b),e = 0,f = c.length;
                f > e;
                e += 1)
                if (d = c[e],h = 0,d.hasOwnProperty( "r" ) && (h = d.r),d.hasOwnProperty( "t" ) && (y = d.t,z = y / p),0 > h && (j = c[e + 1],j && j.hasOwnProperty( "t" ) ? i = j.t / p : (i = q.timelineConverter.calcMediaTimeFromPresentationTime( b.segmentAvailabilityRange.end,b ),b.segmentDuration = d.d / p),h = Math.ceil( (i - z) / (d.d / p) ) - 1),l) {
                    if (v)
                        break;
                    A += h + 1
                }else
            ...
            if (!v) {
                var C,
                    D,
                    E = c[0];
                C = void 0 === E.t ? 0 : q.timelineConverter.calcPresentationTimeFromMediaTime( E.t / p,b ),D = q.timelineConverter.calcPresentationTimeFromMediaTime( (y - d.d) / p,b ),b.segmentAvailabilityRange = {
                    start : C,
                    end : D
                },
                b.availableSegmentsNumber = A + 1
            }
            return x
        },
        q = function (a) {
            var b,
                ...
                i = this,
                j = a.adaptation.period.mpd.manifest.Period_asArray[a.adaptation.period.index].AdaptationSet_asArray[a.adaptation.index].Representation_asArray[a.index].SegmentTemplate,
                k = a.segmentDuration,
                l = a.segmentAvailabilityRange,
                m = null,
                n = null;
            for (f = a.startNumber,b = r.call(i,a),d = b.start,e = b.end,c = d;
                e >= c;
                c += 1)
                m = o.call( i,a,c ),m.replacementTime = (f + c - 1) * a.segmentDuration,n = j.media,n = g( n,"Number",m.replacementNumber ),n = g( n,"Time",m.replacementTime ),m.media = n,h.push( m ),m = null;
            return a.availableSegmentsNumber = Math.ceil( (l.end - l.start) / k ),h
        },
        r = function (c) {
            var e,
                f,
            ...
            m = 0 / 0,
                ...
                p = 2 * i,
                q = Math.max( 2 * j,10 * i );
            return l || (l = h.timelineConverter.calcSegmentAvailabilityRange( c,b )),b && !h.timelineConverter.isTimeSyncCompleted() ? (e = Math.floor( l.start / i ),f = Math.floor( l.end / i ),g = {
                start : e,
                end : f
            }) : (o ? (n = A( d,c ),m = n ? h.timelineConverter.calcPeriodRelativeTimeFromMpdRelativeTime( c,n.presentationStartTime ) : d > 0 ? d * i : h.timelineConverter.calcPeriodRelativeTimeFromMpdRelativeTime( c,a || o[0].presentationStartTime )) : m = d > 0 ? d * i : b ? l.end : l.start,e = Math.floor( Math.max( m - p,l.start ) / i ),f = Math.floor( Math.min( e + q / i,l.end / i ) ),g = {
                start : e,
                end : f
            })
        },
        ...
        t = function (a,c,d,e,f,h,i) {
            ...
            return k = n.timelineConverter.calcPresentationTimeFromMediaTime( o,a ),l = k + p,m = new Dash.vo.Segment,m.representation = a,m.duration = p,m.mediaStartTime = o,m.presentationStartTime = k,m.availabilityStartTime = a.adaptation.period.mpd.manifest.loadedTime,m.availabilityEndTime = n.timelineConverter.calcAvailabilityEndTimeFromPresentationTime( l,a.adaptation.period.mpd,b ),m.wallStartTime = n.timelineConverter.calcWallTimeForSegment( m,b ),m.replacementTime = c,m.replacementNumber = j( m,i ),f = g( f,"Number",m.replacementNumber ),f = g( f,"Time",m.replacementTime ),m.media = f,m.mediaRange = h,m.availabilityIdx = i,m
        },
        u = function (a) {
            var b,
                c,
            ...
            for (h = a.startNumber,e = r.call(i,a),f = Math.max(e.start,0),g = Math.min(e.end,k.SegmentURL_asArray.length - 1),b = f;
                g >= b;
                b += 1)
                d = k.SegmentURL_asArray[b],c = o.call( i,a,b ),c.replacementTime = (h + b - 1) * a.segmentDuration,c.media = d.media,c.mediaRange = d.mediaRange,c.index = d.index,c.indexRange = d.indexRange,j.push( c ),c = null;
            return a.availableSegmentsNumber = l,j
        },
        v = function (a) {
            var b,
                c = this,
                d = a.segmentInfoType;
            return"SegmentBase" !== d && "BaseURL" !== d && B.call( c,a ) ? ("SegmentTimeline" === d ? b = p.call( c,a ) : "SegmentTemplate" === d ? b = q.call( c,a ) : "SegmentList" === d && (b = u.call( c,a )),w.call( c,a,b )) : b = a.segments,b
        },
        w = function (a,c) {
            var d;
            if (a.segments = c,d = c.length - 1,b && isNaN( this.timelineConverter.getExpectedLiveEdge() )) {
                var e = c[d].presentationStartTime,
                    f = this.metricsModel.getMetricsFor( "stream" );
                this.timelineConverter.setExpectedLiveEdge( e ),this.metricsModel.updateManifestUpdateInfo( this.metricsExt.getCurrentManifestUpdate( f ),{
        ...
        x = function (a) {
            ...
            return a.segments = null,v.call( b,a ),a
        },
        y = function (a,e) {
            var f = this,
                g = a.initialization,
                h = "BaseURL" !== a.segmentInfoType && "SegmentBase" !== a.segmentInfoType;
            a.segmentAvailabilityRange = f.timelineConverter.calcSegmentAvailabilityRange( a,b ),e || (d = -1),x.call( f,a ),g || f.baseURLExt.loadInitialization( a ),h || f.baseURLExt.loadSegments( a,c,a.indexRange ),g && h && f.notify( f.eventList.ENAME_REPRESENTATION_UPDATED,a )
        },
        z = function (a,b) {
            var c,
                d,
            ...
            if (g && h > 0)
                for (f = 0;
                    h > f;
                    f += 1)
                    if (c = g[f],d = c.presentationStartTime,e = c.duration,a + e / 2 >= d && d + e > a - e / 2) {
                        i = c.availabilityIdx;
                        break
                    }
            return i
        ...
        A = function (a,b) {
            ...
            for (d = 0;
                e > d;
                d += 1)
                if (c = b.segments[d],c.availabilityIdx === a)
                    return c;
            return null
        },
        B = function (a) {
        ...
        C = function (a) {
            if (null === a || void 0 === a)
                return null;
            var b,
                d = new MediaPlayer.vo.FragmentRequest,
                e = a.representation,
        ...
        F = function (b) {
            ...
            return a = null,d += 1,h = d,g = n.call( i,b ),g ? (e = new MediaPlayer.vo.FragmentRequest,e.action = e.ACTION_COMPLETE,e.index = h,e.mediaType = c,i.debug.log( "Signal complete." )) : (v.call( i,b ),f = A( h,b ),e = C.call( i,f )),e
        },
        G = function (a,b) {
            b.segments && this.notify( this.eventList.ENAME_REPRESENTATION_UPDATED,b )
        },
        H = function (a,b,d,e,f) {
            if (!f && c === e) {
                var g,
                    h,
                    i,
                ...
                for (g = 0,h = b.length;
                    h > g;
                    g += 1)
                    i = b[g],j = t.call( k,d,i.startTime,i.duration,i.timescale,i.media,i.mediaRange,m ),l.push( j ),j = null,m += 1;
                d.segmentAvailabilityRange = {
                    start : l[0].presentationStartTime,
                    end : l[h - 1].presentationStartTime
                },
                d.availableSegmentsNumber = h,w.call( k,d,l ),d.initialization && this.notify( this.eventList.ENAME_REPRESENTATION_UPDATED,d )
            }
        };
    return{
        debug : void 0,
        ...
        setup : function () {
            this.initializationLoaded = G,this.segmentsLoaded = H
        },
        initialize : function (a) {
            this.subscribe( this.eventList.ENAME_REPRESENTATION_UPDATED,a.trackController ),c = a.getType(),b = a.isDynamic(),this.streamProcessor = a
        },
        getType : function () {
            return c
        },
        ...
        reset : function () {
            e = 0,a = void 0,d = -1,this.unsubscribe( this.eventList.ENAME_REPRESENTATION_UPDATED,this.streamProcessor.trackController )
        },
        getInitRequest : m,
        getSegmentRequestForTime : D,
        getNextSegmentRequest : F,
        generateSegmentRequestForTime : E,
        updateRepresentation : y
    }
...
Dash.dependencies.DashManifestExtensions = function () {
    ...
    getIsTypeOf : function (a,b) {
        ...
        var c,
            d,
            e,
            f = a.ContentComponent_asArray,
            g = new RegExp( "text" !== b ? b : "(vtt|ttml)" ),
            h = !1,
            i = !1;
        if (f)
            for (c = 0,d = f.length;
                d > c;
                c += 1)
                f[c].contentType === b && (h = !0,i = !0);
        if (a.hasOwnProperty( "mimeType" ) && (h = g.test( a.mimeType ),i = !0),!i)
            for (c = 0,d = a.Representation_asArray.length;
                !i && d > c;)
                e = a.Representation_asArray[c],e.hasOwnProperty( "mimeType" ) && (h = g.test( e.mimeType ),i = !0),c += 1;
        return h
    },
    ...
    getAdaptationForId : function (a,b,c) {
        ...
        for (d = 0,e = f.length;
            e > d;
            d += 1)
            if (f[d].hasOwnProperty( "id" ) && f[d].id === a)
                return f[d];
        return null
    },
    ...
    getAdaptationsForType : function (a,b,c) {
        ...
        for (d = 0,e = g.length;
            e > d;
            d += 1)
            this.getIsTypeOf( g[d],c ) && h.push( f.processAdaptation( g[d] ) );
        return h
    },
    getAdaptationForType : function (a,b,c) {
        ...
        var d,
            ...
            f,
            g = this;
        if (f = this.getAdaptationsForType( a,b,c ),!f || 0 === f.length)
            return null;
        for (d = 0,e = f.length;
            e > d;
            d += 1)
    ...
    getDuration : function (a) {
        var b;
        return b = a.hasOwnProperty( "mediaPresentationDuration" ) ? a.mediaPresentationDuration : Number.POSITIVE_INFINITY
    },
    ...
    getRegularPeriods : function (a,b) {
        var c,
            ...
            j = null,
            k = null;
        for (c = 0,d = a.Period_asArray.length;
            d > c;
            c += 1)
            i = a.Period_asArray[c],i.hasOwnProperty( "start" ) ? (k = new Dash.vo.Period,k.start = i.start) : null !== h && i.hasOwnProperty( "duration" ) ? (k = new Dash.vo.Period,k.start = j.start + j.duration,k.duration = i.duration) : 0 !== c || g || (k = new Dash.vo.Period,k.start = 0),null !== j && isNaN( j.duration ) && (j.duration = k.start - j.start),null !== k && i.hasOwnProperty( "id" ) && (k.id = i.id),null !== k && i.hasOwnProperty( "duration" ) && (k.duration = i.duration),null !== k && (k.index = c,k.mpd = b,f.push( k )),h = i,i = null,j = k,k = null;
        return 0 === f.length ? f : (b.checkTime = e.getCheckTime( a,f[0] ),null !== j && isNaN( j.duration ) && (j.duration = e.getEndTimeForLastPeriod( b ) - j.start),f)
    },
    getMpd : function (a) {
    ...
    getFetchTime : function (a,b) {
        var c = this.timelineConverter.calcPresentationTimeFromWallTime( a.loadedTime,b );
        return c
    },
    ...
    getEndTimeForLastPeriod : function (a) {
        var b;
        if (a.manifest.mediaPresentationDuration)
            b = a.manifest.mediaPresentationDuration;
        else {
            if (isNaN( a.checkTime ))
    ...
    getEventsForPeriod : function (a,b) {
        ...
        if (d)
            for (var f = 0;
                ...
                if (g.period = b,g.timescale = 1,!d[f].hasOwnProperty( "schemeIdUri" ))
    ...
    getEventStreamForAdaptationSet : function (a,b) {
        var c = [
            ...
            d = a.Period_asArray[b.period.index].AdaptationSet_asArray[b.index].InbandEventStream_asArray;
        if (d)
            for (var e = 0;
                e < d.length;
                e += 1) {
                var f = new Dash.vo.EventStream;
                if (f.timescale = 1,!d[e].hasOwnProperty( "schemeIdUri" ))
                    throw"Invalid EventStream. SchemeIdUri has to be set";
    ...
    getEventStreamForRepresentation : function (a,b) {
        var c = [
            ...
            d = a.Period_asArray[b.adaptation.period.index].AdaptationSet_asArray[b.adaptation.index].Representation_asArray[b.index].InbandEventStream_asArray;
        if (d)
            for (var e = 0;
                e < d.length;
                e++) {
                var f = new Dash.vo.EventStream;
                if (f.timescale = 1,f.representation = b,!d[e].hasOwnProperty( "schemeIdUri" ))
                    throw"Invalid EventStream. SchemeIdUri has to be set";
                f.schemeIdUri = d[e].schemeIdUri,d[e].hasOwnProperty( "timescale" ) && (f.timescale = d[e].timescale),d[e].hasOwnProperty( "value" ) && (f.value = d[e].value),c.push( f )
            }
        return c
...
Dash.dependencies.DashMetricsExtensions = function () {
    ...
    var a = function (a,b) {
        ...
        for (h = 0;
            h < a.length;
            h += 1)
            for (c = a[h],e = c.AdaptationSet_asArray,i = 0;
                i < e.length;
                i += 1)
                for (d = e[i],g = d.Representation_asArray,j = 0;
                    j < g.length;
                    j += 1)
                    if (f = g[j],b === f.id)
                        return j;
        ...
        d = function (a,b) {
            ...
            for (h = 0;
                h < a.length;
                h += 1)
                for (d = a[h],f = d.AdaptationSet_asArray,i = 0;
                    i < f.length;
                    i += 1)
                    if (e = f[i],g = e.Representation_asArray,c.call( this,e,b ))
                        return g.length;
            return-1
        },
        e = function (a) {
    ...
    return{
        ...
        getCurrentPlaybackRate : j,
        getCurrentHttpRequest : k,
        getHttpRequests : l,
        getCurrentDroppedFrames : m,
        getCurrentSchedulingInfo : n,
        getCurrentDVRInfo : p,
        getCurrentManifestUpdate : o
    }
...
Dash.dependencies.DashParser = function () {
    ...
    var a = 31536e3,
        ...
        l = function () {
            ...
            ],a = {},a.name = "AdaptationSet",a.isRoot = !1,a.isArray = !0,a.parent = null,a.children = [
            ],a.properties = d,b = {},b.name = "Representation",b.isRoot = !1,b.isArray = !0,b.parent = a,b.children = [
            ],b.properties = d,a.children.push( b ),c = {},c.name = "SubRepresentation",c.isRoot = !1,c.isArray = !0,c.parent = b,c.children = [
            ],c.properties = d,b.children.push( c ),a
        },
        m = function () {
            var a,
                b,
            ...
            ],a = {},a.name = "Period",a.isRoot = !1,a.isArray = !0,a.parent = null,a.children = [
            ],a.properties = d,b = {},b.name = "AdaptationSet",b.isRoot = !1,b.isArray = !0,b.parent = a,b.children = [
            ],b.properties = d,a.children.push( b ),c = {},c.name = "Representation",c.isRoot = !1,c.isArray = !0,c.parent = b,c.children = [
            ],c.properties = d,b.children.push( c ),a
        },
        n = function () {
            var a,
            ...
            ],a = {},a.name = "mpd",a.isRoot = !0,a.isArray = !0,a.parent = null,a.children = [
            ],a.properties = e,b = {},b.name = "Period",b.isRoot = !1,b.isArray = !0,b.parent = null,b.children = [
            ],b.properties = e,a.children.push( b ),c = {},c.name = "AdaptationSet",c.isRoot = !1,c.isArray = !0,c.parent = b,c.children = [
            ],c.properties = e,b.children.push( c ),d = {},d.name = "Representation",d.isRoot = !1,d.isArray = !0,d.parent = c,d.children = [
            ],d.properties = e,c.children.push( d ),a
        },
        o = function () {
            var a = [
            ];
...
Dash.dependencies.FragmentExtensions = function () {
    ...
    var a = function (a) {
        for (var b,
            ...
            h = new DataView( a ),
            i = 0;
            "tfdt" !== e && i < h.byteLength;) {
            for (d = h.getUint32(i),i += 4,e = "",f = 0;
                4 > f;
                f += 1)
                g = h.getInt8( i ),e += String.fromCharCode( g ),i += 1;
            "moof" !== e && "traf" !== e && "tfdt" !== e && (i += d - 8)
        }
        if (i === h.byteLength)
            throw"Error finding live offset.";
        return c = h.getUint8( i ),this.debug.log( "position: " + i ),0 === c ? (i += 4,b = h.getUint32( i,!1 )) : (i += d - 16,b = utils.Math.to64BitNumber( h.getUint32( i + 4,!1 ),h.getUint32( i,!1 ) )),{
            version : c,
        ...
        b = function (a) {
            for (var b,
                ...
                for (g = i.getUint32(j),j += 4,f = "",e = 0;
                    4 > e;
                    e += 1)
                    h = i.getInt8( j ),f += String.fromCharCode( h ),j += 1;
                "moof" !== f && "traf" !== f && "sidx" !== f ? j += g - 8 : "sidx" === f && (j -= 8)
            }
            return b = i.getUint8( j + 8 ),j += 12,c = i.getUint32( j + 4,!1 ),j += 8,d = 0 === b ? i.getUint32( j,!1 ) : utils.Math.to64BitNumber( i.getUint32( j + 4,!1 ),i.getUint32( j,!1 ) ),{
        ...
        c = function (b) {
            var c,
                ...
                h = !1;
            c = b,g.onloadend = function () {
                h || (d = "Error loading fragment: " + c,f.notify( f.eventList.ENAME_FRAGMENT_LOADING_COMPLETED,null,new Error( d ) ))
            },g.onload = function () {
                h = !0,e = a( g.response ),f.notify( f.eventList.ENAME_FRAGMENT_LOADING_COMPLETED,e )
            },g.onerror = function () {
                d = "Error loading fragment: " + c,f.notify( f.eventList.ENAME_FRAGMENT_LOADING_COMPLETED,null,new Error( d ) )
            },g.responseType = "arraybuffer",g.open( "GET",c ),g.send( null )
        };
    return{
        debug : void 0,
        notify : void 0,
...
Dash.dependencies.RepresentationController = function () {
    ...
    var a,
        ...
        f = function (c,f,i) {
            var k = this;
            if (d = !0,k.notify( k.eventList.ENAME_DATA_UPDATE_STARTED ),e = j.call( k,f ),a = h.call( k,k.abrController.getQualityFor( i ) ),b = c,"video" !== i && "audio" !== i)
                return k.notify( k.eventList.ENAME_DATA_UPDATE_COMPLETED,b,a ),void g.call( k );
            for (var l = 0;
                l < e.length;
                l += 1)
                k.indexHandler.updateRepresentation( e[l],!0 )
        },
        g = function () {
            var a = new Date,
        ...
        i = function () {
            for (var a = 0,
                ...
                b > a;
                a += 1)
                if (null === e[a].segmentAvailabilityRange || null === e[a].initialization)
                    return!1;
            return!0
        },
        j = function (a) {
        ...
        k = function (a) {
            for (var b,
                ...
                f > d;
                d += 1)
                b = e[d],b.segmentAvailabilityRange = c.timelineConverter.calcSegmentAvailabilityRange( b,a )
        },
        l = function (c,e) {
            for (var f,
                h = this,
                j = e,
                k = h.metricsModel.getMetricsFor( "stream" ),
                l = h.metricsExt.getCurrentManifestUpdate( k ),
                m = !1,
                n = 0;
                n < l.trackInfo.length;
                n += 1)
                if (f = l.trackInfo[n],f.index === j.index && f.mediaType === h.streamProcessor.getType()) {
                    m = !0;
                    break
                }
            m || h.metricsModel.addManifestUpdateTrackInfo( l,j.id,j.index,j.adaptation.period.index,h.streamProcessor.getType(),j.presentationTimeOffset,j.startNumber,j.segmentInfoType ),i() && (d = !1,h.metricsModel.updateManifestUpdateInfo( l,{
                latency : a.segmentAvailabilityRange.end - h.streamProcessor.playbackController.getTime()
            } ),this.notify( this.eventList.ENAME_DATA_UPDATE_COMPLETED,b,a ),g.call( h ))
        },
        m = function (a,b) {
            k.call( this,b )
        },
        n = function () {
            k.call( this,!0 ),this.indexHandler.updateRepresentation( a,!1 )
        },
        o = function (b) {
            var c = b.streamProcessor,
                d = this,
                e = d.timelineConverter.calcSegmentAvailabilityRange( a,c.isDynamic() );
            d.metricsModel.addDVRInfo( c.getType(),c.playbackController.getTime(),c.getStreamInfo().manifestInfo,e )
        },
        p = function (b,c,d,e) {
            var f = this;
            c === f.streamProcessor.getType() && (a = f.getRepresentationForQuality( e ),g.call( f ))
        };
    return{
        system : void 0,
        debug : void 0,
        ...
        setup : function () {
            this.qualityChanged = p,this.representationUpdated = l,this.wallclockTimeUpdated = m,this.liveEdgeFound = n,this.bufferLevelUpdated = o
        },
        initialize : function (a) {
    ...
    var a = 0,
        ...
        k = function (a,c) {
            var d,
                e,
                f = a.segmentDuration,
                h = a.adaptation.period.start,
                i = h + a.adaptation.period.duration,
                j = {
                    start : h,
                    end : i
                };
            return c ? b && !isNaN( f ) || !a.segmentAvailabilityRange ? (d = a.adaptation.period.mpd.checkTime,e = g( new Date( (new Date).getTime() ),a.adaptation.period ),h = Math.max( e - a.adaptation.period.mpd.timeShiftBufferDepth,0 ),i = isNaN( d ) ? e : Math.min( d,e ),j = {
                start : h,
                end : i
            }) : a.segmentAvailabilityRange : j
        },
        l = function (a,b) {
...
MediaPlayer.dependencies.AbrController = function () {
    ...
    var a = !0,
        ...
        g = function (a) {
            var b;
            return d.hasOwnProperty( a ) || (d[a] = 0),b = d[a]
        },
        h = function (a,b) {
            d[a] = b
        },
        ...
        k = function (a,b,c) {
            var d,
                e = this,
                f = this.adapter.convertDataToTrack( c ).mediaInfo,
                g = f.type;
            d = f.trackCount - 1,j( g ) !== d && (i( g,d ),e.notify( e.eventList.ENAME_TOP_QUALITY_INDEX_CHANGED,g,d ))
        };
    return{
        debug : void 0,
        adapter : void 0,
        ...
        getPlaybackQuality : function (b) {
            var c,
                ...
                n = function (a) {
                    var b = j( m );
                    c = a.value,k = a.confidence,0 > c && (c = 0),c > b && (c = b),d = e( m ),c !== d && (f( m,c ),h( m,k ),l.notify( l.eventList.ENAME_QUALITY_CHANGED,m,d,c ))
                };
            c = e( m ),k = g( m ),a && (l.abrRulesCollection.downloadRatioRule && l.abrRulesCollection.downloadRatioRule.setStreamProcessor( b ),i = l.abrRulesCollection.getRules( MediaPlayer.rules.ABRRulesCollection.prototype.QUALITY_SWITCH_RULES ),l.rulesController.applyRules( i,b,n.bind( l ),c,function (a,b) {
                return Math.min( a,b )
            } ))
        },
        setPlaybackQuality : function (a,c) {
            var d = e( a ),
                g = null !== c && !isNaN( c ) && c % 1 === 0;
            if (!g)
                throw"argument is not an integer";
            c !== d && c >= 0 && b.hasOwnProperty( a ) && c <= b[a] && (f( a,c ),this.notify( this.eventList.ENAME_QUALITY_CHANGED,a,d,c ))
        },
        getQualityFor : function (a) {
            return e( a )
        },
        getConfidenceFor : function (a) {
            return g( a )
        },
        isPlayingAtTopQuality : function () {
            var a,
                b = this,
                c = b.getQualityFor( "audio" ),
                d = b.getQualityFor( "video" );
            return a = c === j( "audio" ) && d === j( "video" )
        },
        reset : function () {
            var e,
                f = this.abrRulesCollection.getRules( MediaPlayer.rules.ABRRulesCollection.prototype.QUALITY_SWITCH_RULES ),
                g = f.length,
                h = 0;
            for (h;
                g > h;
                h += 1)
                e = f[h],"function" == typeof e.reset && e.reset();
            a = !0,b = {},c = {},d = {}
        }
    }
...
MediaPlayer.dependencies.BufferController = function () {
    ...
    var a,
        ...
        t = !1,
        u = function () {
            var a = this.streamProcessor.getFragmentModel().getLoadingRequests();
            return i > h && (v( s,i ) || v( a,i )) ? !1 : i !== h
        },
        v = function (a,b) {
            var c = 0,
                d = a.length;
        ...
        x = function (a,c,d,e) {
            var f = this;
            c === f.streamProcessor.getFragmentModel() && (f.debug.log( "Initialization finished loading: " + b ),g[e] = d,e === h && u.call( f ) && Y.call( f ))
        },
        y = function (a,b,c,d,e) {
            if (b === this.streamProcessor.getFragmentModel()) {
                var f,
                    g = this.streamProcessor.getFragmentModel().getExecutedRequestForQualityAndIndex( d,e ),
                    h = this.streamProcessor.getTrackForQuality( d ),
                    i = this.adapter.getEventsFor( h.mediaInfo,this.streamProcessor ),
                    j = this.adapter.getEventsFor( h,this.streamProcessor );
                (i.length > 0 || j.length > 0) && (f = C.call( this,c,g,i,j ),this.streamProcessor.getEventController().addInbandEvents( f )),c = D.call( this,c ),s.push( {
                    bytes : c,
                    quality : d,
                    index : e
                } ),w( s,"index" ),P.call( this )
            }
        },
        z = function (a,b,c) {
            r = !0,d = {
            ...
            var e = this,
                f = isNaN( c );
            return b !== h && f || b !== i && !f ? void R.call( e,b,c ) : void e.sourceBufferExt.append( o,a )
        },
        A = function (c,e,g,h) {
            if (o === e) {
                this.isBufferingCompleted() && this.mediaSourceExt.signalEndOfStream( a );
                var i,
                    j = this;
                if (h)
                    return h.code === f && (s.unshift( {
                        bytes : g,
                        quality : d.quality,
                        index : d.index
                    } ),l = .8 * J.call( j ),j.notify( j.eventList.ENAME_QUOTA_EXCEEDED,l ),H.call( j )),void(r = !1);
                if (B.call( j ),G.call( j ) || (j.notify( j.eventList.ENAME_QUOTA_EXCEEDED,l ),H.call( j )),i = j.sourceBufferExt.getAllRanges( o ),i && i.length > 0) {
                    var k,
                        m;
                    for (k = 0,m = i.length;
                        m > k;
                        k += 1)
                        j.debug.log( "Buffered " + b + " Range: " + i.start( k ) + " - " + i.end( k ) )
                }
                Q.call( j,d.quality,d.index ),j.notify( j.eventList.ENAME_BYTES_APPENDED,d.quality,d.index )
            }
        },
        B = function () {
            var a = this,
                b = a.playbackController.getTime();
            return k = a.sourceBufferExt.getBufferLength( o,b ),a.notify( a.eventList.ENAME_BUFFER_LEVEL_UPDATED,k ),E.call( a ),L.call( a ),e > k && M.call( a,!1 ),!0
        },
        C = function (a,b,c,d) {
            var e,
                f,
                ...
                k = Math.pow( 256,2 ),
                l = Math.pow( 256,3 ),
                m = Math.max( isNaN( b.startTime ) ? 0 : b.startTime,0 ),
                n = [
                ];
            t = !1,h = c.concat( d );
            for (var o = 0;
                o < h.length;
                o++)
                n[h[o].schemeIdUri] = h[o];
            for (;
                j < a.length && (e = String.fromCharCode( a[j + 4],a[j + 5],a[j + 6],a[j + 7] ),f = a[j] * l + a[j + 1] * k + 256 * a[j + 2] + 1 * a[j + 3],"moov" != e && "moof" != e);) {
                if ("emsg" == e) {
                    t = !0;
                    for (var p = [
                        "",
                        ...
                        r = j + 12;
                        f + j > r;)
                        0 === q || 1 == q || 6 == q ? (0 !== a[r] ? p[q] += String.fromCharCode( a[r] ) : q += 1,r += 1) : (p[q] = a[r] * l + a[r + 1] * k + 256 * a[r + 2] + 1 * a[r + 3],r += 4,q += 1);
                    g = this.adapter.getEvent( p,n,m ),g && i.push( g )
                }
                j += f
            }
            return i
        ...
        E = function () {
            var a = F.call( this ),
                b = 2 * c,
                d = k - a;
            d >= b && !q ? (q = !0,this.notify( this.eventList.ENAME_BUFFER_LEVEL_OUTRUN )) : b / 2 > d && q && (this.notify( this.eventList.ENAME_BUFFER_LEVEL_BALANCED ),q = !1,P.call( this ))
        },
        F = function () {
        ...
        H = function () {
            var b,
                ...
                e,
                f = this,
                g = f.playbackController.getTime();
            o && (e = f.fragmentController.getExecutedRequestForTime( f.streamProcessor.getFragmentModel(),g ),c = e && !isNaN( e.startTime ) ? e.startTime : Math.floor( g ),d = f.sourceBufferExt.getBufferRange( o,g ),null === d && o.buffered.length > 0 && (c = o.buffered.end( o.buffered.length - 1 )),b = o.buffered.start( 0 ),f.sourceBufferExt.remove( o,b,c,a ))
        },
        I = function (a,b,d,e) {
            o === b && (B.call( this ),this.notify( this.eventList.ENAME_BUFFER_CLEARED,d,e,G.call( this ) ),G.call( this ) || setTimeout( H.bind( this ),1e3 * c ))
        },
        J = function () {
            var a,
                b,
                c = this,
                d = c.sourceBufferExt.getAllRanges( o ),
                e = 0;
            if (!d)
                return e;
            for (b = 0,a = d.length;
        ...
        K = function () {
            var a = m === n - 1;
            a && !j && (j = !0,this.notify( this.eventList.ENAME_BUFFERING_COMPLETED ))
        },
        L = function () {
            var a = this.playbackController.getTimeToStreamEnd(),
                b = this.streamProcessor.isDynamic() ? c / 2 : c;
            b > k && (a > c || c >= a && !j) ? M.call( this,!1 ) : M.call( this,!0 )
        },
        M = function (a) {
            p !== a && (p = a,this.debug.log( p ? "Got enough " + b + " buffer to start." : "Waiting for more " + b + " buffer before starting playback." ),this.eventBus.dispatchEvent( {
                type : p ? "bufferLoaded" : "bufferStalled",
                data : {
                    bufferType : b
                }
            } ),this.notify( this.eventList.ENAME_BUFFER_LEVEL_STATE_CHANGED,a ))
        },
        N = function (a) {
            o.timestampOffset !== a && (o.timestampOffset = a)
        },
        O = function () {
            var a = this;
            B.call( a ),P.call( a )
        ...
        P = function () {
            u.call( this ) ? Y.call( this ) : U.call( this )
        },
        Q = function (a,b) {
            r = !1,isNaN( b ) ? S.call( this,a ) : T.call( this,b ),P.call( this )
        },
        R = function (a,b) {
            r = !1,this.notify( this.eventList.ENAME_BYTES_REJECTED,a,b ),P.call( this )
        },
        S = function (a) {
            i = a
        },
        T = function (a) {
            m = Math.max( a,m ),K.call( this )
        },
        U = function () {
            var a;
            0 === s.length || q || r || u.call( this ) || !G.call( this ) || (a = s.shift(),z.call( this,a.bytes,a.quality,a.index ))
        },
        V = function (a,b,d) {
            var e,
                f = this;
            N.call( f,d.MSETimeOffset ),e = f.streamProcessor.getStreamInfo().manifestInfo.minBufferTime,c !== e && (f.setMinBufferTime( e ),f.notify( f.eventList.ENAME_MIN_BUFFER_TIME_UPDATED,e ))
        },
        W = function (a,b,c) {
            var d = this;
            b === d.streamProcessor.getFragmentModel() && (n = c.index,K.call( d ))
        },
        X = function (a,c,d,e) {
            if (b === c) {
                var f = this;
                h !== e && (N.call( f,f.streamProcessor.getTrackForQuality( e ).MSETimeOffset ),h = e,u.call( f ) && Y.call( f ))
            }
        },
        Y = function () {
            var a = this;
            if (g[h]) {
                ...
                a.notify( a.eventList.ENAME_INIT_REQUESTED,h )
        },
        Z = function () {
            P.call( this )
        },
    ...
    return{
        ...
        reset : function (b) {
            var e = this;
            g = [
            ],l = Number.POSITIVE_INFINITY,p = null,c = null,i = -1,h = 0,e.sourceBufferExt.unsubscribe( e.sourceBufferExt.eventList.ENAME_SOURCEBUFFER_APPEND_COMPLETED,e,A ),e.sourceBufferExt.unsubscribe( e.sourceBufferExt.eventList.ENAME_SOURCEBUFFER_REMOVE_COMPLETED,e,I ),d = null,q = !1,r = !1,s = [
            ],b || (e.sourceBufferExt.abort( a,o ),e.sourceBufferExt.removeSourceBuffer( a,o )),o = null
        }
    }
},MediaPlayer.dependencies.BufferController.BUFFER_SIZE_REQUIRED = "required",MediaPlayer.dependencies.BufferController.BUFFER_SIZE_MIN = "min",MediaPlayer.dependencies.BufferController.BUFFER_SIZE_INFINITY = "infinity",MediaPlayer.dependencies.BufferController.DEFAULT_MIN_BUFFER_TIME = 8,MediaPlayer.dependencies.BufferController.BUFFER_TIME_AT_TOP_QUALITY = 30,MediaPlayer.dependencies.BufferController.BUFFER_TIME_AT_TOP_QUALITY_LONG_FORM = 300,MediaPlayer.dependencies.BufferController.LONG_FORM_CONTENT_DURATION_THRESHOLD = 600,MediaPlayer.dependencies.BufferController.prototype = {
...
MediaPlayer.utils.EventBus = function () {
    ...
    var a = [
        ...
        l = function (b) {
            var c = this;
            a = [
            ],b && b.length > 0 && (a = b),c.debug.log( "Added " + b.length + " inline events" )
        },
        m = function (a) {
            for (var c = this,
                d = 0;
        ...
        p = function () {
            var a = this;
            if (c)
                for (var b = this.videoModel.getCurrentTime(),
                    d = 0;
                    d < c.length;
                    d++) {
                    var e = c[d];
        ...
        q = function () {
            var a = this,
                ...
                c = b.url;
            b.hasOwnProperty( "Location" ) && (c = b.Location),a.debug.log( "Refresh manifest @ " + c ),a.manifestLoader.load( c )
        };
    return{
        manifestModel : void 0,
    ...
    var a = [
        ...
        d = function (b,c) {
            var d = this,
                ...
                g = d.scheduleRulesCollection.getRules( MediaPlayer.rules.ScheduleRulesCollection.prototype.FRAGMENTS_TO_EXECUTE_RULES );
        ...
        e = function (a,b) {
            var c = this;
            c.isInitializationRequest( b ) ? c.notify( c.eventList.ENAME_INIT_FRAGMENT_LOADING_START,a,b ) : c.notify( c.eventList.ENAME_MEDIA_FRAGMENT_LOADING_START,a,b )
        },
        f = function (a,b,c) {
            var d = this,
                e = d.process( c );
            return null === e ? void d.debug.log( "No " + b.mediaType + " bytes to push." ) : (d.isInitializationRequest( b ) ? d.notify( d.eventList.ENAME_INIT_FRAGMENT_LOADED,a,e,b.quality ) : d.notify( d.eventList.ENAME_MEDIA_FRAGMENT_LOADED,a,e,b.quality,b.index ),void j.call( this ))
        },
        g = function (a,b) {
            this.notify( this.eventList.ENAME_STREAM_COMPLETED,a,b )
        },
        h = function () {
            j.call( this )
        },
            ...
            for (g = 0;
                ...
                if (e = i[g])
                    for (h = 0;
                        h < a.length;
                        h += 1)
                        f = a[h],d = f.getContext().streamProcessor.getType(),e.mediaType === d && (e instanceof MediaPlayer.vo.FragmentRequest || (e = f.getPendingRequestForTime( e.startTime )),f.executeRequest( e ));
            b = !1
        },
        j = function (a) {
            b || (b = !0,d.call( this,a,i.bind( this ) ))
        };
    return{
        system : void 0,
        debug : void 0,
        ...
        setup : function () {
            this.fragmentLoadingStarted = e,this.fragmentLoadingCompleted = f,this.streamCompleted = g,this.bufferLevelBalanced = h
        },
        process : function (a) {
            var b = null;
        ...
        isFragmentLoadedOrPending : function (a,b) {
            var d,
                e = c( a );
            return e ? d = e.isFragmentLoadedOrPending( b ) : !1
        },
        getPendingRequests : function (a) {
            var b = c( a );
            return b ? b.getPendingRequests() : null
        },
        getLoadingRequests : function (a) {
            var b = c( a );
            return b ? b.getLoadingRequests() : null
        },
        isInitializationRequest : function (a) {
            return a && a.type && -1 !== a.type.toLowerCase().indexOf( "initialization" )
        },
        getLoadingTime : function (a) {
            var b = c( a );
            return b ? b.getLoadingTime() : null
        },
        ...
        abortRequestsForModel : function (a) {
            a && a.abortRequests(),j.call( this )
        },
        prepareFragmentForLoading : function (a,b) {
            var d = c( a );
            d && b && d.addRequest( b ) && j.call( this,b )
        },
        executePendingRequests : function () {
            j.call( this )
        },
        resetModel : function (a) {
            this.abortRequestsForModel( a ),this.cancelPendingRequestsForModel( a )
        }
    }
    ...
    var a = 3,
        ...
        d = function (a,e) {
            var f = new XMLHttpRequest,
                ...
                j = null,
                k = this;
            c.push( f ),a.requestStartDate = new Date,g = k.metricsModel.addHttpRequest( a.mediaType,null,a.type,a.url,null,a.range,a.requestStartDate,null,null,null,null,a.duration ),k.metricsModel.appendHttpTrace( g,a.requestStartDate,a.requestStartDate.getTime() - a.requestStartDate.getTime(),[
                0
            ] ),j = a.requestStartDate,f.open( "GET",k.tokenAuthentication.addTokenAsQueryArg( a.url ),!0 ),f.responseType = "arraybuffer",f = k.tokenAuthentication.setTokenInRequestHeader( f ),a.range && f.setRequestHeader( "Range","bytes=" + a.range ),f.onprogress = function (b) {
                var c = new Date;
                h && (h = !1,(!b.lengthComputable || b.lengthComputable && b.total != b.loaded) && (a.firstByteDate = c,g.tresponse = c)),k.metricsModel.appendHttpTrace( g,c,c.getTime() - j.getTime(),[
                    f.response ? f.response.byteLength : 0
                ] ),j = c
            },f.onload = function () {
                if (!(f.status < 200 || f.status > 299)) {
                    ...
                    var b,
                        ...
                        d = new Date,
                        e = f.response;
                    a.firstByteDate || (a.firstByteDate = a.requestStartDate),a.requestEndDate = d,b = a.firstByteDate.getTime() - a.requestStartDate.getTime(),c = a.requestEndDate.getTime() - a.firstByteDate.getTime(),k.debug.log( "loaded " + a.mediaType + ":" + a.type + ":" + a.startTime + " (" + f.status + ", " + b + "ms, " + c + "ms)" ),g.tresponse = a.firstByteDate,g.tfinish = a.requestEndDate,g.responsecode = f.status,k.metricsModel.appendHttpTrace( g,d,d.getTime() - j.getTime(),[
                        e ? e.byteLength : 0
                    ] ),j = d,k.notify( k.eventList.ENAME_LOADING_COMPLETED,a,e )
                }
                ...
                if (-1 !== c.indexOf( f ) && (c.splice( c.indexOf( f ),1 ),i)) {
                    ...
                    var h,
                        ...
                        m = new Date,
                        n = f.response;
                    a.firstByteDate || (a.firstByteDate = a.requestStartDate),a.requestEndDate = m,h = a.firstByteDate.getTime() - a.requestStartDate.getTime(),l = a.requestEndDate.getTime() - a.firstByteDate.getTime(),k.debug.log( "failed " + a.mediaType + ":" + a.type + ":" + a.startTime + " (" + f.status + ", " + h + "ms, " + l + "ms)" ),g.tresponse = a.firstByteDate,g.tfinish = a.requestEndDate,g.responsecode = f.status,k.metricsModel.appendHttpTrace( g,m,m.getTime() - j.getTime(),[
                        n ? n.byteLength : 0
                    ] ),j = m,e > 0 ? (k.debug.log( "Failed loading fragment: " + a.mediaType + ":" + a.type + ":" + a.startTime + ", retry in " + b + "ms attempts: " + e ),e--,setTimeout( function () {
                        d.call( k,a,e )
                    },b )) : (k.debug.log( "Failed loading fragment: " + a.mediaType + ":" + a.type + ":" + a.startTime + " no retry attempts left" ),k.errHandler.downloadError( "content",a.url,f ),k.notify( k.eventList.ENAME_LOADING_COMPLETED,a,null,new Error( "failed loading fragment" ) ))
                }
            },f.send()
        },
        e = function (a) {
            ...
            c.open( "HEAD",a.url,!0 ),c.onload = function () {
                c.status < 200 || c.status > 299 || (d = !0,b.notify( b.eventList.ENAME_CHECK_FOR_EXISTENCE_COMPLETED,!0,a ))
            },c.onloadend = c.onerror = function () {
                d || b.notify( b.eventList.ENAME_CHECK_FOR_EXISTENCE_COMPLETED,!1,a )
            },c.send()
        };
    return{
        metricsModel : void 0,
        ...
        load : function (b) {
            b ? d.call( this,b,a ) : this.notify( this.eventList.ENAME_LOADING_COMPLETED,b,null,new Error( "request is null" ) )
        },
        checkForExistence : function (a) {
            return a ? void e.call( this,a ) : void this.notify( this.eventList.ENAME_CHECK_FOR_EXISTENCE_COMPLETED,!1,a )
        },
        abort : function () {
            var a,
                b,
...
MediaPlayer.dependencies.FragmentModel = function () {
    ...
    var a,
        ...
        g = function (a) {
            var b = this;
            b.notify( b.eventList.ENAME_FRAGMENT_LOADING_STARTED,a ),b.fragmentLoader.load( a )
        },
        h = function (a) {
            var c = b.indexOf( a );
            -1 !== c && b.splice( c,1 )
        ...
        i = function (a,b) {
            ...
            for (c = d;
                c >= 0;
                c -= 1)
                if (g = a[c],e = g.startTime,f = e + g.duration,!isNaN( e ) && !isNaN( f ) && b >= e && f > b || isNaN( e ) && isNaN( b ))
                    return g;
            return null
        },
        j = function (a,b) {
            if (a) {
                var c = a.mediaType,
                    ...
                    e = a.type,
                    f = a.startTime,
                    g = a.availabilityStartTime,
                    h = a.duration,
                    i = a.quality,
                    j = a.range;
                this.metricsModel.addSchedulingInfo( c,d,e,f,g,h,i,j,b )
            }
        },
        k = function (a,c,e,f) {
            d.splice( d.indexOf( c ),1 ),e && !f ? (b.push( c ),j.call( this,c,MediaPlayer.vo.metrics.SchedulingInfo.EXECUTED_STATE ),this.notify( this.eventList.ENAME_FRAGMENT_LOADING_COMPLETED,c,e )) : (j.call( this,c,MediaPlayer.vo.metrics.SchedulingInfo.FAILED_STATE ),this.notify( this.eventList.ENAME_FRAGMENT_LOADING_FAILED,c ))
        },
        l = function (a,b,c) {
            var d = this.getExecutedRequestForQualityAndIndex( b,c );
            d && (this.removeExecutedRequest( d ),isNaN( c ) || (e.push( d ),j.call( this,d,MediaPlayer.vo.metrics.SchedulingInfo.REJECTED_STATE )))
        },
        m = function () {
            f = !0
        },
    ...
    return{
        ...
        setup : function () {
            this.bufferLevelOutrun = m,this.bufferLevelBalanced = n,this.bytesRejected = l,this.loadingCompleted = k
        },
        ...
        addRequest : function (a) {
            return!a || this.isFragmentLoadedOrPending( a ) ? !1 : (c.push( a ),j.call( this,a,MediaPlayer.vo.metrics.SchedulingInfo.PENDING_STATE ),!0)
        },
        ...
        getPendingRequestForTime : function (a) {
            return i( c,a )
        },
        getLoadingRequestForTime : function (a) {
            return i( d,a )
        },
        getExecutedRequestForQualityAndIndex : function (a,c) {
            var d,
                e = b.length - 1,
                f = null;
            for (d = e;
                d >= 0;
                d -= 1)
                if (f = b[d],f.quality === a && f.index === c)
                    return f;
            return null
        },
        ...
        removeExecutedRequestsBeforeTime : function (a) {
            ...
            for (c = d;
                c >= 0;
                c -= 1)
                f = b[c],e = f.startTime,!isNaN( e ) && a > e && h.call( this,f )
        },
        cancelPendingRequests : function (a) {
            var b = this,
                ...
                e = d;
            return c = [
            ],void 0 !== a && (c = d.filter( function (b) {
                return b.quality === a ? !1 : (e.splice( e.indexOf( b ),1 ),!0)
            } )),e.forEach( function (a) {
                j.call( b,a,MediaPlayer.vo.metrics.SchedulingInfo.CANCELED_STATE )
            } ),e
        },
        abortRequests : function () {
            ...
            for (var a = 0,
                ...
                b > a;
                a += 1)
                this.removeExecutedRequest( d[a] );
            d = [
            ]
        },
        executeRequest : function (a) {
            var e = this,
                f = c.indexOf( a );
            if (a && -1 !== f)
                switch (c.splice( f,1 ),a.action) {
                    case"complete":
                        b.push( a ),j.call( e,a,MediaPlayer.vo.metrics.SchedulingInfo.EXECUTED_STATE ),e.notify( e.eventList.ENAME_STREAM_COMPLETED,a );
                        break;
                    case"download":
                        d.push( a ),j.call( e,a,MediaPlayer.vo.metrics.SchedulingInfo.LOADING_STATE ),g.call( e,a );
                        break;
                    default:
...
MediaPlayer.dependencies.LiveEdgeFinder = function () {
    ...
    var a,
        ...
        c = function (a) {
            var b = a.value,
                c = ((new Date).getTime() - this.streamProcessor.getStreamInfo().manifestInfo.loadedTime.getTime()) / 1e3;
            null !== b ? this.notify( this.eventList.ENAME_LIVE_EDGE_FOUND,b,c ) : this.notify( this.eventList.ENAME_LIVE_EDGE_SEARCH_ERROR,c )
        },
        d = function () {
            if (this.streamProcessor.isDynamic() && !b) {
                var d = this;
                a = d.scheduleRulesCollection.getRules( MediaPlayer.rules.ScheduleRulesCollection.prototype.LIVE_EDGE_RULES ),b = !0,this.rulesController.applyRules( a,d.streamProcessor,c.bind( d ),null,function (a,b) {
                    return b
                } )
            }
        };
    return{
        ...
        initialize : function (a) {
            this.streamProcessor = a,this.fragmentLoader = a.fragmentLoader,this.scheduleRulesCollection.liveEdgeBinarySearchRule && this.scheduleRulesCollection.liveEdgeBinarySearchRule.setFinder( this )
        },
    ...
    var a = 3,
        ...
        d = function (a,e) {
            var f,
                ...
                n = this;
            l = function () {
                h.status < 200 || h.status > 299 || (k = !1,j = new Date,n.tokenAuthentication.checkRequestHeaderForToken( h ),n.metricsModel.addHttpRequest( "stream",null,"MPD",a,null,null,i,j,h.status,null,null ),f = n.parser.parse( h.responseText,g ),f ? (f.url = a,f.loadedTime = j,n.metricsModel.addManifestUpdate( "stream",f.type,i,j,f.availabilityStartTime ),n.notify( n.eventList.ENAME_MANIFEST_LOADED,f )) : n.notify( n.eventList.ENAME_MANIFEST_LOADED,null,new Error( "Failed loading manifest: " + a ) ))
            },m = function () {
                k && (k = !1,n.metricsModel.addHttpRequest( "stream",null,"MPD",a,null,null,i,new Date,h.status,null,null ),e > 0 ? (n.debug.log( "Failed loading manifest: " + a + ", retry in " + b + "ms attempts: " + e ),e--,setTimeout( function () {
                    d.call( n,a,e )
                },b )) : (n.debug.log( "Failed loading manifest: " + a + " no retry attempts left" ),n.errHandler.downloadError( "manifest",a,h ),n.notify( n.eventList.ENAME_MANIFEST_LOADED,null,new Error( "Failed loading manifest: " + a + " no retry attempts left" ) )))
            };
            try {
    ...
    return{
        ...
        setValue : function (b) {
            a = b,this.eventBus.dispatchEvent( {
                type : "manifestLoaded",
                data : b
            } ),this.notify( this.eventList.ENAME_MANIFEST_UPDATED,b )
        }
    }
...
MediaPlayer.dependencies.ManifestUpdater = function () {
    ...
    var a = 0 / 0,
        ...
        f = function () {
            e.call( this ),isNaN( a ) || (this.debug.log( "Refresh manifest in " + a + " seconds." ),b = setTimeout( h.bind( this ),Math.min( 1e3 * a,Math.pow( 2,31 ) - 1 ),this ))
        },
        g = function () {
            var b,
                c,
                d = this,
                e = d.manifestModel.getValue();
            void 0 !== e && null !== e && (b = d.manifestExt.getRefreshDelay( e ),c = ((new Date).getTime() - e.loadedTime.getTime()) / 1e3,a = Math.max( b - c,0 ),f.call( d ))
        },
        h = function () {
            var a,
                b,
                c = this;
            d || (d = !0,a = c.manifestModel.getValue(),b = a.url,a.hasOwnProperty( "Location" ) && (b = a.Location),c.manifestLoader.load( b ))
        },
        i = function (a,b,d) {
            d || (this.manifestModel.setValue( b ),this.debug.log( "Manifest has been refreshed." ),c || g.call( this ))
        },
        j = function () {
            this.start()
        },
    ...
    return{
        ...
        manifestLoader : void 0,
        setup : function () {
            g.call( this ),this.streamsComposed = l,this.manifestLoaded = i,this.playbackStarted = j,this.playbackPaused = k
        },
        start : function () {
            c = !1,g.call( this )
        },
...
MediaPlayer.dependencies.MediaSourceExtensions = function () {
    ...
    attachMediaSource : function (a,b) {
        "use strict";
        b.setSource( window.URL.createObjectURL( a ) )
    },
    ...
    setDuration : function (a,b) {
        "use strict";
        return a.duration = b,a.duration
    },
    signalEndOfStream : function (a) {
        "use strict";
        "open" === a.readyState && a.endOfStream()
    }
},
MediaPlayer.models.MetricsModel = function () {
    ...
    return{
        ...
        addHttpRequest : function (a,b,c,d,e,f,g,h,i,j,k,l) {
            ...
            return m.stream = a,m.tcpid = b,m.type = c,m.url = d,m.actualurl = e,m.range = f,m.trequest = g,m.tresponse = h,m.tfinish = i,m.responsecode = j,m.interval = k,m.mediaduration = l,this.getMetricsFor( a ).HttpList.push( m ),this.metricAdded( a,this.adapter.metricsList.HTTP_REQUEST,m ),m
        },
        appendHttpTrace : function (a,b,c,d) {
            var e = new MediaPlayer.vo.metrics.HTTPRequest.Trace;
            return e.s = b,e.d = c,e.b = d,a.trace.push( e ),this.metricUpdated( a.stream,this.adapter.metricsList.HTTP_REQUEST_TRACE,a ),e
        },
        addTrackSwitch : function (a,b,c,d,e) {
            var f = new MediaPlayer.vo.metrics.TrackSwitch;
        ...
        addManifestUpdateTrackInfo : function (a,b,c,d,e,f,g,h) {
...
MediaPlayer.dependencies.Notifier = function () {
    ...
    return{
        ...
        subscribe : function (b,e,f,g) {
            if (!f && e[b] && (f = e[b] = e[b].bind( e )),!d.call( this,b ))
                throw"object does not support given event " + b;
            if (!e)
                throw"observer object cannot be null or undefined";
            if (!f)
                throw"event handler cannot be null or undefined";
...
MediaPlayer.dependencies.PlaybackController = function () {
    ...
    var a,
        ...
        i = function (a) {
            var b,
                c = parseInt( this.uriQueryFragModel.getURIFragmentData.s );
            return e ? (!isNaN( c ) && c > 1262304e3 && (b = c - a.manifestInfo.availableFrom.getTime() / 1e3,(b > h || b < h - a.manifestInfo.DVRWindowSize) && (b = null)),b = b || h) : b = !isNaN( c ) && c < a.duration && c >= 0 ? c : a.start,b
        },
        j = function () {
            var a,
                c = this,
                e = c.getTime(),
                f = c.metricsModel.getMetricsFor( d.mediaInfo.type ),
                g = c.metricsExt.getCurrentDVRInfo( f ),
                h = g ? g.range : null;
            return h ? e >= h.start && e <= h.end ? e : a = Math.max( h.end - 2 * b.manifestInfo.minBufferTime,h.start ) : 0 / 0
        },
        k = function () {
            var b = this,
                c = function () {
            ...
            null !== a && l.call( this ),a = setInterval( c,f )
        },
        l = function () {
        ...
        o = function (a,c,f) {
            d = this.adapter.convertDataToTrack( f ),b = d.mediaInfo.streamInfo,e = a.streamProcessor.isDynamic(),n.call( this )
        },
        p = function () {
            0 !== c.getElement().readyState && m.call( this )
        },
        q = function () {
            c && (c.unlisten( "play",r ),c.unlisten( "pause",s ),c.unlisten( "error",z ),c.unlisten( "seeking",t ),c.unlisten( "seeked",u ),c.unlisten( "timeupdate",v ),c.unlisten( "progress",w ),c.unlisten( "ratechange",x ),c.unlisten( "loadedmetadata",y ))
        },
        r = function () {
            n.call( this ),this.notify( this.eventList.ENAME_PLAYBACK_STARTED,this.getTime() )
        },
        s = function () {
        ...
        v = function () {
            var a = this.getTime();
            a !== g && (g = a,this.notify( this.eventList.ENAME_PLAYBACK_TIME_UPDATED,this.getTimeToStreamEnd() ))
        },
        w = function () {
            var a,
                d,
                e,
                f = c.getElement().buffered;
            f.length && (a = f.length - 1,d = f.end( a ),e = i.call( this,b ) + b.duration - d),this.notify( this.eventList.ENAME_PLAYBACK_PROGRESS,c.getElement().buffered,e )
        },
        x = function () {
            this.notify( this.eventList.ENAME_PLAYBACK_RATE_CHANGED )
        },
        y = function () {
            this.debug.log( "Got loadmetadata event." ),(!e || this.timelineConverter.isTimeSyncCompleted()) && m.call( this ),this.notify( this.eventList.ENAME_PLAYBACK_METADATA_LOADED ),k.call( this )
        },
        z = function (a) {
        ...
        B = function (a) {
            c = a,c.listen( "play",r ),c.listen( "pause",s ),c.listen( "error",z ),c.listen( "seeking",t ),c.listen( "seeked",u ),c.listen( "timeupdate",v ),c.listen( "progress",w ),c.listen( "ratechange",x ),c.listen( "loadedmetadata",y )
        };
    return{
        debug : void 0,
        timelineConverter : void 0,
        ...
        setup : function () {
            this.dataUpdateCompleted = o,this.liveEdgeFound = p,r = r.bind( this ),s = s.bind( this ),z = z.bind( this ),t = t.bind( this ),u = u.bind( this ),v = v.bind( this ),w = w.bind( this ),x = x.bind( this ),y = y.bind( this )
        },
        initialize : function (a,d) {
            b = a,c !== d && (q.call( this ),B.call( this,d ))
        },
        getTimeToStreamEnd : function () {
            var a = c.getCurrentTime();
            return i.call( this,b ) + b.duration - a
        },
        ...
        reset : function () {
            l.call( this ),q.call( this ),c = null,b = null,g = 0,h = 0 / 0
        }
    }
...
MediaPlayer.dependencies.ProtectionController = function () {
    ...
    var a = null,
        ...
        d = function (a) {
            for (var c = this,
                ...
                for (var g = 0;
                    g < e.length;
                    ++g)
                    if (b[f].isSupported( e[g] ) && c.protectionExt.supportsCodec( b[f].keysTypeString,d )) {
                        var h = e[g].KID;
                        return h || (h = "unknown"),c.protectionModel.addKeySystem( h,e[g],b[f] ),c.debug.log( "DRM: Selected Key System: " + b[f].keysTypeString + " For KID: " + h ),h
                    }
        ...
        f = function (a,b,c,d) {
            this.protectionModel.updateFromMessage( a,b,c,d )
        };
    return{
        system : void 0,
        debug : void 0,
        ...
        var a = this,
            b = function (b,c) {
                var d = null,
                    ...
                    f = new DOMParser,
                    g = f.parseFromString( b,"application/xml" );
                if (g.getElementsByTagName( "Challenge" )[0]) {
                    var h = g.getElementsByTagName( "Challenge" )[0].childNodes[0].nodeValue;
                    h && (d = BASE64.decode( h ))
                }else
                    a.notify( a.eventList.ENAME_KEY_SYSTEM_UPDATE_COMPLETED,null,new Error( "DRM: playready update, can not find Challenge in keyMessage" ) );
                var i = g.getElementsByTagName( "name" ),
                    j = g.getElementsByTagName( "value" );
                i.length != j.length && a.notify( a.eventList.ENAME_KEY_SYSTEM_UPDATE_COMPLETED,null,new Error( "DRM: playready update, invalid header name/value pair in keyMessage" ) );
                for (var k = 0;
                    k < i.length;
                    k++)
                    e[k] = {
                ...
                l.onload = function () {
                    200 == l.status ? a.notify( a.eventList.ENAME_KEY_SYSTEM_UPDATE_COMPLETED,new Uint8Array( l.response ) ) : a.notify( a.eventList.ENAME_KEY_SYSTEM_UPDATE_COMPLETED,null,new Error( 'DRM: playready update, XHR status is "' + l.statusText + '" (' + l.status + "), expected to be 200. readyState is " + l.readyState ) )
                },l.onabort = function () {
                    a.notify( a.eventList.ENAME_KEY_SYSTEM_UPDATE_COMPLETED,null,new Error( 'DRM: playready update, XHR aborted. status is "' + l.statusText + '" (' + l.status + "), readyState is " + l.readyState ) )
                },l.onerror = function () {
                    a.notify( a.eventList.ENAME_KEY_SYSTEM_UPDATE_COMPLETED,null,new Error( 'DRM: playready update, XHR error. status is "' + l.statusText + '" (' + l.status + "), readyState is " + l.readyState ) )
                },l.open( "POST",c ),l.responseType = "arraybuffer",e && e.forEach( function (a) {
            ...
            d = function (a) {
                var b = 0,
                    ...
                    j = null;
                if ("pro"in a)
                    g = BASE64.decodeArray( a.pro.__text );
                else {
                    if (!("prheader"in a))
                        return null;
...
MediaPlayer.models.ProtectionModel = function () {
    ...
    return{
        ...
        protectionExt : void 0,
        setup : function () {
            this.keySystemUpdateCompleted = g
        },
        init : function (a) {
            this.videoModel = a,b = this.videoModel.getElement()
        },
        addKeySession : function (a,b,g) {
            var h = null;
            return h = this.protectionExt.createSession( f[a].keys,b,g ),this.protectionExt.listenToKeyAdded( h,c ),this.protectionExt.listenToKeyError( h,d ),this.protectionExt.listenToKeyMessage( h,e ),f[a].initData = g,f[a].keySessions.push( h ),h
        },
        addKeySystem : function (a,c,d) {
            var e = null;
            e = this.protectionExt.createMediaKeys( d.keysTypeString ),this.protectionExt.setMediaKey( b,e ),f[a] = {
                kID : a,
                contentProtection : c,
                keySystem : d,
                keys : e,
        ...
        removeKeySystem : function (a) {
            if (null !== a && void 0 !== f[a] && 0 !== f[a].keySessions.length) {
                for (var b = f[a].keySessions,
                    g = 0;
                    g < b.length;
                    ++g)
                    this.protectionExt.unlistenToKeyError( b[g],d ),this.protectionExt.unlistenToKeyAdded( b[g],c ),this.protectionExt.unlistenToKeyMessage( b[g],e ),b[g].close();
                f[a] = void 0
            }
        },
        needToAddKeySession : function (a) {
            var b = null;
            return b = f[a],b.keySystem.needToAddKeySession( b.initData,b.keySessions )
        },
        getInitData : function (a) {
            var b = null;
            return b = f[a],b.keySystem.getInitData( b.contentProtection )
        },
        updateFromMessage : function (b,c,d,e) {
            a = c,f[b].keySystem.getUpdate( d,e )
        },
        ...
        listenToKeyError : function (a) {
            ...
            for (var b = 0;
                b < f.length;
                ++b)
                for (var c = f[b].keySessions,
                    e = 0;
                    e < c.length;
                    ++e)
                    this.protectionExt.listenToKeyError( c[e],a )
        },
        listenToKeyMessage : function (a) {
            ...
            for (var b = 0;
                ...
                for (var c = f[b].keySessions,
                    ...
                    d < c.length;
                    ++d)
                    this.protectionExt.listenToKeyMessage( c[d],a )
        },
        listenToKeyAdded : function (a) {
            ...
            for (var b = 0;
                b < f.length;
                ++b)
                for (var d = f[b].keySessions,
                    e = 0;
                    e < d.length;
                    ++e)
                    this.protectionExt.listenToKeyAdded( d[e],a )
        }
    }
    ...
    var a,
        ...
        n = function () {
            if (b) {
                i = !1;
                var c = new Date;
                m( c,MediaPlayer.vo.metrics.PlayList.Trace.USER_REQUEST_STOP_REASON ),j = this.metricsModel.addPlayList( a,c,0,MediaPlayer.vo.metrics.PlayList.INITIAL_PLAY_START_REASON ),g && (g = !1),this.debug.log( "ScheduleController " + a + " start." ),w.call( this )
            }
        },
        o = function () {
            g && r.call( this,e.quality ),n.call( this )
        },
        p = function (b) {
        ...
        r = function (a) {
            var b,
                c = this;
            return b = c.adapter.getInitRequest( c.streamProcessor,a ),null !== b && c.fragmentController.prepareFragmentForLoading( c,b ),b
        },
        s = function (a) {
            var b = this,
        ...
        t = function (a) {
            ...
            for (d = 0;
                f > d;
                d += 1)
                b = a[d],c = b.startTime + b.duration / 2,b = this.adapter.getFragmentRequestForTime( this.streamProcessor,e,c,!1 ),this.fragmentController.prepareFragmentForLoading( this,b )
        },
        u = function (a) {
            var b = this;
            return f = a.value,0 >= f ? void b.fragmentController.executePendingRequests() : (b.abrController.getPlaybackQuality( b.streamProcessor ),void q.call( b,v.bind( b ) ))
        },
        v = function (a) {
            var b = a.value;
            null === b || b instanceof MediaPlayer.vo.FragmentRequest || (b = this.adapter.getFragmentRequestForTime( this.streamProcessor,e,b.startTime )),b && (f--,this.fragmentController.prepareFragmentForLoading( this,b ))
        },
        w = function () {
            var a = (new Date).getTime(),
                b = h ? a - h > this.fragmentController.getLoadingTime( this ) : !0;
            !b || i || this.playbackController.isPaused() && (!this.scheduleWhilePaused || d) || (h = a,s.call( this,u.bind( this ) ))
        },
        x = function () {
            var b = this;
        ...
        y = function (a,c,f) {
            e = this.adapter.convertDataToTrack( f ),d || (b = !0),b && o.call( this )
        },
        z = function (b,c) {
        ...
        A = function (a,b) {
            var c = this;
            b === c.streamProcessor.getFragmentModel() && w.call( c )
        },
        B = function () {
            p.call( this )
        },
        ...
        H = function (b,c) {
            var d = this;
            d.metricsModel.addBufferLevel( a,new Date,c ),w.call( this )
        },
        I = function () {
            p.call( this,!1 )
        },
        J = function (b,d,f,g) {
            if (a === d) {
                var h,
                    i = this;
                if (h = c.cancelPendingRequests( f ),e = i.streamProcessor.getTrackForQuality( g ),null === e || void 0 === e)
                    throw"Unexpected error!";
                t.call( i,h ),m( new Date,MediaPlayer.vo.metrics.PlayList.Trace.REPRESENTATION_SWITCH_STOP_REASON )
            }
        },
        K = function () {
            var a = this,
        ...
        N = function (b,d) {
            ...
            var f,
                h = this.metricsModel.getMetricsFor( "stream" ),
                i = this.metricsExt.getCurrentManifestUpdate( h );
            this.debug.log( "ScheduleController " + a + " seek: " + d ),f = new Date,m( f,MediaPlayer.vo.metrics.PlayList.Trace.USER_REQUEST_STOP_REASON ),j = this.metricsModel.addPlayList( a,f,d,MediaPlayer.vo.metrics.PlayList.SEEK_START_REASON ),n.call( this ),this.metricsModel.updateManifestUpdateInfo( i,{
        ...
        Q = function (a,c) {
            var d,
                ...
                i = c - Math.min( 2 * h.minBufferTime,h.DVRWindowSize / 2 ),
                j = g.metricsModel.getMetricsFor( "stream" ),
                k = g.metricsExt.getCurrentManifestUpdate( j );
            d = g.adapter.getFragmentRequestForTime( g.streamProcessor,e,i ),f = d.startTime + d.duration / 2,g.playbackController.setLiveStartTime( f ),g.metricsModel.updateManifestUpdateInfo( k,{
                currentTime : f,
                presentationStartTime : c,
                latency : c - f,
                clientTimeOffset : g.timelineConverter.getClientTimeOffset()
            } ),b = !0,o.call( g )
        };
    return{
        debug : void 0,
        ...
        unsubscribe : void 0,
        setup : function () {
            this.liveEdgeFound = Q,this.qualityChanged = J,this.dataUpdateStarted = D,this.dataUpdateCompleted = y,this.mediaFragmentLoadingStart = A,this.fragmentLoadingFailed = B,this.streamCompleted = z,this.bufferCleared = F,this.bytesAppended = C,this.bufferLevelStateChanged = G,this.bufferLevelUpdated = H,this.initRequested = E,this.quotaExceeded = I,this.closedCaptioningRequested = L,this.playbackStarted = M,this.playbackSeeking = N,this.playbackRateChanged = O,this.wallclockTimeUpdated = P
        },
        initialize : function (b,e) {
            var f = this;
            a = b,f.streamProcessor = e,f.playbackController = e.playbackController,f.fragmentController = e.fragmentController,f.liveEdgeFinder = e.liveEdgeFinder,f.bufferController = e.bufferController,d = e.isDynamic(),c = this.fragmentController.getModel( this ),f.scheduleRulesCollection.bufferLevelRule && f.scheduleRulesCollection.bufferLevelRule.setScheduleController( f ),f.scheduleRulesCollection.pendingRequestsRule && f.scheduleRulesCollection.pendingRequestsRule.setScheduleController( f ),f.scheduleRulesCollection.playbackTimeRule && f.scheduleRulesCollection.playbackTimeRule.setScheduleController( f )
        },
...
MediaPlayer.dependencies.SourceBufferExtensions = function () {
    "use strict";
    this.system = void 0,this.errHandler = void 0,this.notify = void 0,this.subscribe = void 0,this.unsubscribe = void 0,this.eventList = {
        ...
        if (null !== f) {
            for (e = 0,d = f.length;
                ...
                if (g = f.start( e ),h = f.end( e ),null === i)
                    k = Math.abs( g - b ),b >= g && h > b ? (i = g,j = h) : l >= k && (i = g,j = h);
                else {
                    if (k = g - j,!(l >= k))
                        break;
                    j = h
    ...
    waitForUpdateEnd : function (a,b) {
        ...
        var c,
            d = 50,
            e = function () {
                a.updating || (clearInterval( c ),b( !0 ))
            },
            f = function () {
                a.updating || (a.removeEventListener( "updateend",f,!1 ),b( !0 ))
            };
        if (!a.updating)
            return void b( !0 );
        ...
        if (d)
            try {
                c.waitForUpdateEnd( a,function () {
                    a[d]( b ),c.waitForUpdateEnd( a,function () {
                        c.notify( c.eventList.ENAME_SOURCEBUFFER_APPEND_COMPLETED,a,b )
                    } )
                } )
            }catch (e) {
                c.notify( c.eventList.ENAME_SOURCEBUFFER_APPEND_COMPLETED,a,b,e )
            }
    },
    remove : function (a,b,c,d) {
        var e = this;
        try {
            b >= 0 && c > b && "ended" !== d.readyState && a.remove( b,c ),this.waitForUpdateEnd( a,function () {
                e.notify( e.eventList.ENAME_SOURCEBUFFER_REMOVE_COMPLETED,a,b,c )
            } )
        }catch (f) {
            e.notify( e.eventList.ENAME_SOURCEBUFFER_REMOVE_COMPLETED,a,b,c,f )
        }
    },
    abort : function (a,b) {
        "use strict";
...
MediaPlayer.dependencies.Stream = function () {
    ...
    var a,
        ...
        q = null,
        r = function () {
            j && this.playbackController.start()
        },
        s = function () {
            this.playbackController.pause()
        },
        t = function (a) {
            j && (this.debug.log( "Do seek: " + a ),this.playbackController.seek( a ))
        },
        u = function (a) {
            var b,
                c = this,
                d = g.video,
                e = g ? g.video.codec : null;
            if (b = "msneedkey" !== a.type ? a.type : e,n.push( {
                type : b,
                initData : a.initData
            } ),this.debug.log( "DRM: Key required for - " + b ),d && e && !m)
                try {
                    m = c.protectionController.selectKeySystem( d )
                }catch (f) {
                    s.call( c ),c.debug.log( f ),c.errHandler.mediaKeySystemSelectionError( f )
                }
            m && c.protectionController.ensureKeySession( m,b,a.initData )
        },
        v = function (a) {
            var b = this,
                c = null,
                ...
                e = null,
                f = null;
            this.debug.log( "DRM: Got a key message..." ),c = a.target,d = new Uint16Array( a.message.buffer ),e = String.fromCharCode.apply( null,d ),f = a.destinationURL,b.protectionController.updateFromMessage( m,c,e,f )
        },
        w = function () {
        ...
        y = function (a,b) {
            var c = this,
                d = function (e) {
                    c.debug.log( "MediaSource is open!" ),c.debug.log( e ),a.removeEventListener( "sourceopen",d ),a.removeEventListener( "webkitsourceopen",d ),b( a )
                };
            a.addEventListener( "sourceopen",d,!1 ),a.addEventListener( "webkitsourceopen",d,!1 ),c.mediaSourceExt.attachMediaSource( a,c.videoModel )
        },
        z = function () {
            var c,
                d = this,
            ...
            for (f;
                e > f;
                f += 1)
                c = h[f],c.reset( l ),c = null;
            q && q.reset(),h = [
            ],b && d.mediaSourceExt.detachMediaSource( d.videoModel ),j = !1,m = null,n = [
            ],g = {},b = null,a = null
        },
        A = function (a,c) {
            var d,
                ...
                k = i.adapter.getMediaInfoForType( c,p,a );
            if ("text" === a && (j = function (a) {
                return d = a.mimeType
            }),null !== k) {
                var l,
                    m = j.call( i,k ),
                ...
                if (m === d)
                    try {
                        n = i.sourceBufferExt.createSourceBuffer( b,k )
                    }catch (o) {
                        i.errHandler.mediaSourceError( "Error creating " + a + " source buffer." )
                    }
                else if (e = m,i.debug.log( a + " codec: " + e ),g[a] = k,l = k.contentProtection,l && !i.capabilities.supportsMediaKeys())
                    i.errHandler.capabilityError( "mediakeys" );
                else if (i.capabilities.supportsCodec( i.videoModel.getElement(),e ))
                    try {
                        n = i.sourceBufferExt.createSourceBuffer( b,k )
                    }catch (o) {
                        i.errHandler.mediaSourceError( "Error creating " + a + " source buffer." )
                    ...
                    var r = a + "Codec (" + e + ") is not supported.";
                    i.errHandler.manifestError( r,"codec",c ),i.debug.log( r )
                }
                null === n ? i.debug.log( "No buffer was created, skipping " + a + " data." ) : (f = i.system.getObject( "streamProcessor" ),h.push( f ),f.initialize( d || a,n,i.videoModel,i.fragmentController,i.playbackController,b,i,q ),f.setMediaInfo( k ),i.adapter.updateData( f ))
            }else
                i.debug.log( "No " + a + " data." )
        },
        B = function () {
            var b,
                c = this;
            q = c.system.getObject( "eventController" ),q.initialize( c.videoModel ),b = c.adapter.getEventsFor( p ),q.addInlineEvents( b ),A.call( c,"video",a ),A.call( c,"audio",a ),A.call( c,"text",a )
        },
        C = function () {
            var a,
                c,
                d = this;
            a = p.manifestInfo.duration,c = d.mediaSourceExt.setDuration( b,a ),d.debug.log( "Duration successfully set to: " + c ),j = !0,F.call( d )
        },
        D = function () {
            this.debug.log( "element loaded!" ),k = !0,E.call( this )
        },
        E = function () {
            j && k && 0 === p.index && (q.start(),i && r.call( this ))
        },
        F = function () {
            var a = this,
                b = h.length,
            ...
            if (j) {
                for (c;
                    ...
                    if (h[c].isUpdating())
                        return;
                o = !1,a.notify( a.eventList.ENAME_STREAM_UPDATED )
            }
        },
        G = function (a,b) {
            var c = b.code,
            ...
            if (-1 !== c) {
                ...
                l = !0,this.debug.log( "Video Element Error: " + d ),this.debug.log( b ),this.errHandler.mediaSourceError( d ),this.reset()
            }
        },
        H = function (c) {
            var d,
                e = this,
                f = function (c) {
                    if (b = c,B.call( e ),0 === h.length) {
                        var d = "No streams to play.";
                        e.errHandler.manifestError( d,"nostreams",a ),e.debug.log( d )
                    }else
                        e.liveEdgeFinder.initialize( h[0] ),e.liveEdgeFinder.subscribe( e.liveEdgeFinder.eventList.ENAME_LIVE_EDGE_FOUND,e.playbackController ),C.call( e ),E.call( e )
                };
            a = c,d = e.mediaSourceExt.createMediaSource(),y.call( e,d,f )
        },
        I = function () {
            var a = L(),
                c = a.length,
            ...
            for (d;
                c > d;
                d += 1)
                if (!a[d].isBufferingCompleted())
                    return;
            b && this.mediaSourceExt.signalEndOfStream( b )
        },
        J = function () {
            F.call( this )
        },
        K = function (a,b,c) {
            c && (s.call( this ),this.debug.log( c ),this.errHandler.mediaKeyMessageError( c ))
        },
        L = function () {
            var a,
                b,
            ...
            for (d;
                e > d;
                d += 1)
                b = h[d],a = b.getType(),("audio" === a || "video" === a) && c.push( b );
            return c
        },
        M = function (b) {
            var c,
                ...
                g = h.length,
                i = 0;
            for (o = !0,a = f.manifestModel.getValue(),p = b,f.debug.log("Manifest updated... set new data on buffers."),q && (d = f.adapter.getEventsFor(p),q.addInlineEvents(d)),i;
                g > i;
                i += 1)
                e = h[i],c = f.adapter.getMediaInfoForType( a,p,e.getType() ),e.setMediaInfo( c ),this.adapter.updateData( e )
        };
    return{
        system : void 0,
        manifestModel : void 0,
        ...
        setup : function () {
            this.bufferingCompleted = I,this.dataUpdateCompleted = J,this.playbackError = G,this.playbackMetaDataLoaded = D,this.keySystemUpdateCompleted = K
        },
        load : function (a) {
            H.call( this,a )
        },
        ...
        setPlaybackController : function (a) {
            this.playbackController = a,a.initialize( p,this.videoModel )
        },
...
MediaPlayer.dependencies.StreamController = function () {
    ...
    var a,
        ...
        j = function (a,b) {
            var c = a.getVideoModel().getElement(),
                d = b.getVideoModel().getElement();
            d.parentNode || c.parentNode.insertBefore( d,c ),c.style.width = "0px",d.style.width = "100%",m( c,d ),l.call( this,a ),k.call( this,b )
        },
        k = function (a) {
            var b = a.getPlaybackController();
            b.subscribe( b.eventList.ENAME_PLAYBACK_STARTED,this.manifestUpdater ),b.subscribe( b.eventList.ENAME_PLAYBACK_PAUSED,this.manifestUpdater ),b.subscribe( b.eventList.ENAME_PLAYBACK_SEEKING,this ),b.subscribe( b.eventList.ENAME_PLAYBACK_TIME_UPDATED,this ),b.subscribe( b.eventList.ENAME_PLAYBACK_PROGRESS,this )
        },
        l = function (a) {
            var b = this,
                c = a.getPlaybackController();
            setTimeout( function () {
                c.unsubscribe( c.eventList.ENAME_PLAYBACK_STARTED,b.manifestUpdater ),c.unsubscribe( c.eventList.ENAME_PLAYBACK_PAUSED,b.manifestUpdater ),c.unsubscribe( c.eventList.ENAME_PLAYBACK_SEEKING,b ),c.unsubscribe( c.eventList.ENAME_PLAYBACK_TIME_UPDATED,b ),c.unsubscribe( c.eventList.ENAME_PLAYBACK_PROGRESS,b )
            },1 )
        },
        m = function (a,b) {
            [
        ...
        o = function (b,c) {
            var e = this;
            e.metricsModel.addDroppedFrames( "video",e.videoExt.getPlaybackQuality( a.getVideoModel().getElement() ) ),r() && (a.getVideoModel().getElement().seeking || d > c && v.call( this,a,r() ))
        },
        p = function (b,c) {
            var d = s( c );
            d && d !== a && v.call( this,a,d,c )
        },
        q = function () {
            var a = r();
        ...
        s = function (a) {
            var c = 0,
                d = null,
                e = b.length;
            e > 0 && (c += b[0].getStartTime());
            for (var f = 0;
                e > f;
                f++)
                if (d = b[f],c += d.getDuration(),c > a)
                    return d;
            return null
        },
        t = function () {
        ...
        v = function (b,c,d) {
            !f && b && c && b !== c && (f = !0,b.pause(),a = c,j.call( this,b,c ),i( d ? b.getPlaybackController().getTime() : c.getStartTime() ),g(),b.resetEventController(),a.startEventController(),f = !1)
        },
        w = function () {
            var c,
                d,
                ...
                l,
                m = this,
                n = m.manifestModel.getValue(),
                o = m.metricsModel.getMetricsFor( "stream" ),
                p = m.metricsExt.getCurrentManifestUpdate( o );
            if (n) {
                j = m.adapter.getStreamsInfo( n );
                try {
                    if (0 === j.length)
                        throw new Error( "There are no streams" );
                    for (m.metricsModel.updateManifestUpdateInfo( p,{
                        currentTime : m.videoModel.getCurrentTime(),
                        buffered : m.videoModel.getElement().buffered,
                        presentationStartTime : j[0].start,
                        clientTimeOffset : m.timelineConverter.getClientTimeOffset()
                    } ),h = 0,f = j.length;
                        f > h;
                        h += 1) {
                        for (d = j[h],i = 0,g = b.length;
                            g > i;
                            i += 1)
                            b[i].getId() === d.id && (l = b[i],l.updateData( d ));
                        l || (l = m.system.getObject( "stream" ),c = m.system.getObject( "playbackController" ),l.setStreamInfo( d ),l.setVideoModel( 0 === h ? m.videoModel : t.call( m ) ),l.setPlaybackController( c ),c.subscribe( c.eventList.ENAME_PLAYBACK_ERROR,l ),c.subscribe( c.eventList.ENAME_PLAYBACK_METADATA_LOADED,l ),l.initProtection(),l.setAutoPlay( e ),l.load( n ),l.subscribe( l.eventList.ENAME_STREAM_UPDATED,m ),b.push( l )),m.metricsModel.addManifestUpdateStreamInfo( p,d.id,d.index,d.start,d.duration ),l = null
                    }
                    a || (a = b[0],k.call( m,a ),a.subscribe( a.eventList.ENAME_STREAM_UPDATED,this.liveEdgeFinder ))
                }catch (q) {
                    m.errHandler.manifestError( q.message,"nostreamscomposed",m.manifestModel.getValue() ),m.reset()
                }
            }
        },
        x = function () {
            ...
            for (d;
                ...
                if (b[d].isUpdating())
                    return;
            a.notify( a.eventList.ENAME_STREAMS_COMPOSED )
        },
        y = function (a,b,c) {
            c ? this.reset() : (this.manifestModel.setValue( b ),this.debug.log( "Manifest has loaded." ),w.call( this ))
        };
    return{
        system : void 0,
        videoModel : void 0,
        ...
        setup : function () {
            this.manifestLoaded = y,this.streamUpdated = x,this.playbackSeeking = p,this.playbackProgress = n,this.playbackTimeUpdated = o
        },
        setAutoPlay : function (a) {
            e = a
        },
        ...
        reset : function () {
            ...
            for (var c = 0,
                ...
                c++) {
                var e = b[c];
                e.unsubscribe( e.eventList.ENAME_STREAM_UPDATED,this ),e.reset(),e !== a && u( e.getVideoModel().getElement() )
            }
            b = [
            ],this.manifestUpdater.stop(),this.metricsModel.clearAllCurrentMetrics(),this.manifestModel.setValue( null ),this.timelineConverter.reset(),this.adapter.reset(),f = !1,a = null
        },
        play : g,
        seek : i,
        pause : h
...
MediaPlayer.dependencies.StreamProcessor = function () {
    ...
    var a,
        ...
        f = function (a) {
            var b = this,
                c = "video" === a || "audio" === a ? "bufferController" : "textController";
    ...
    return{
        ...
        getTrackForQuality : function (a) {
            return this.adapter.getTrackInfoForQuality( this.trackController,a )
        },
        isBufferingCompleted : function () {
        ...
        reset : function (a) {
            var c = this,
                d = c.bufferController,
                e = c.trackController,
                f = c.scheduleController,
                g = c.liveEdgeFinder,
                h = c.fragmentController,
                i = c.abrController,
                j = c.playbackController,
                k = this.indexHandler,
                l = this.baseURLExt,
                m = this.getFragmentModel(),
...
MediaPlayer.models.VideoModel = function () {
    ...
    var a,
        ...
        g = function (a,b) {
            var c = a.streamProcessor.getType();
            f.call( this,c,!b )
        };
    return{
        system : void 0,
        setup : function () {
            this.bufferLevelStateChanged = g
        },
        play : function () {
            a.play()
        },
...
MediaPlayer.utils.TTMLParser = function () {
    ...
    var a,
        ...
        h = function (b) {
            ...
            if (a = n.xml_str2json( b ),!f())
                throw c = "TTML document has incorrect structure";
            if (k = g( a.tt,"http://www.w3.org/ns/ttml#parameter" ),a.tt.hasOwnProperty( k + ":frameRate" ) && (a.tt.frameRate = parseInt( a.tt[k + ":frameRate"],10 )),d = a.tt.body.div_asArray[0].p_asArray,!d || 0 === d.length)
                throw c = "TTML document does not contain any cues";
            for (l = 0;
                l < d.length;
                l += 1) {
                if (h = d[l],i = e( h.begin ),j = e( h.end ),isNaN( i ) || isNaN( j ))
                    throw c = "TTML document has incorrect timing value";
                m.push( {
                    start : i,
                    end : j,
                    data : h.__text
    ...
    var a,
        ...
        d = !1,
        e = function () {
            d || (b.hasOwnProperty( "initialize" ) && b.initialize( c,this ),d = !0),this.notify( this.eventList.ENAME_CLOSED_CAPTIONING_REQUESTED,0 )
        },
        f = function (a,c,d) {
            var e = this;
            c === e.streamProcessor.getFragmentModel() && null !== d && e.sourceBufferExt.append( b,d,e.videoModel )
        };
    return{
        sourceBufferExt : void 0,
        debug : void 0,
        ...
        setup : function () {
            this.dataUpdateCompleted = e,this.initFragmentLoaded = f
        },
        initialize : function (a,b,d,e) {
            var f = this;
            c = a,f.setBuffer( b ),f.setMediaSource( d ),f.videoModel = e.videoModel,f.trackController = e.trackController,f.streamProcessor = e
        },
        getBuffer : function () {
            return b
        },
        ...
        reset : function (c) {
            c || (this.sourceBufferExt.abort( a,b ),this.sourceBufferExt.removeSourceBuffer( a,b ))
        }
    }
...
MediaPlayer.dependencies.TextSourceBuffer = function () {
    ...
    return{
        ...
        initialize : function (c,d) {
            b = c,this.videoModel = d.videoModel,a = d.streamProcessor.getCurrentTrack().mediaInfo
        },
        append : function (b) {
            var c,
                d,
                e,
                f = this,
                g = String.fromCharCode.apply( null,new Uint16Array( b ) );
            try {
                c = f.getParser().parse( g ),d = a.id,e = a.lang,f.getTextTrackExtensions().addTextTrack( f.videoModel.getElement(),c,d,e,!0 ),f.eventBus.dispatchEvent( {
                    type : "updateend"
                } )
            }catch (h) {
                f.errHandler.closedCaptionsError( h,"parse",g )
            }
        },
        abort : function () {
        ...
        getParser : function () {
            var a;
            return"text/vtt" === b ? a = this.system.getObject( "vttParser" ) : "application/ttml+xml" === b && (a = this.system.getObject( "ttmlParser" )),a
        },
    ...
    return{
        ...
        deleteCues : function (a) {
            for (var b = 0,
                c = !1;
                !c;) {
                if (null !== a.textTracks[b].cues) {
                    c = !0;
                    break
                }
                b++
            }
            var d = a.textTracks[b],
                e = d.cues,
                f = e.length - 1;
            for (b = f;
                b >= 0;
...
MediaPlayer.rules.DownloadRatioRule = function () {
    ...
    var a = {},
        b = function (a,b,c) {
            var d = a.getTrackForQuality( b ).bandwidth;
            return d / c
        };
    return{
        debug : void 0,
        metricsExt : void 0,
        metricsModel : void 0,
        setStreamProcessor : function (b) {
            var c = b.getType(),
                d = b.getStreamInfo().id;
            a[d] = a[d] || {},a[d][c] = b
        },
        execute : function (c,d) {
            var e,
                ...
                o,
                p = this,
                q = c.getStreamInfo().id,
                r = c.getMediaInfo(),
                s = r.type,
                t = c.getCurrentValue(),
                u = a[q][s],
                v = p.metricsModel.getReadOnlyMetricsFor( s ),
                w = p.metricsExt.getCurrentHttpRequest( v ),
                x = .75;
            if (!v)
                return void d( new MediaPlayer.rules.SwitchRequest );
            if (null === w)
                return void d( new MediaPlayer.rules.SwitchRequest );
            if (f = (w.tfinish.getTime() - w.trequest.getTime()) / 1e3,e = (w.tfinish.getTime() - w.tresponse.getTime()) / 1e3,0 >= f)
                return void d( new MediaPlayer.rules.SwitchRequest );
            if (null === w.mediaduration || void 0 === w.mediaduration || w.mediaduration <= 0 || isNaN( w.mediaduration ))
                return void d( new MediaPlayer.rules.SwitchRequest );
            if (h = w.mediaduration / f,g = w.mediaduration / e * x,isNaN( g ) || isNaN( h ))
                return p.debug.log( "The ratios are NaN, bailing." ),void d( new MediaPlayer.rules.SwitchRequest );
            if (isNaN( g ))
                o = new MediaPlayer.rules.SwitchRequest;
            else if (4 > g)
                t > 0 ? (p.debug.log( "We are not at the lowest bitrate, so switch down." ),j = u.getTrackForQuality( t - 1 ).bandwidth,l = u.getTrackForQuality( t ).bandwidth,i = j / l,i > g ? (p.debug.log( "Things must be going pretty bad, switch all the way down." ),o = new MediaPlayer.rules.SwitchRequest( 0 )) : (p.debug.log( "Things could be better, so just switch down one index." ),o = new MediaPlayer.rules.SwitchRequest( t - 1 ))) : o = new MediaPlayer.rules.SwitchRequest( t );
            else if (n = r.trackCount - 1,n > t)
                if (k = u.getTrackForQuality( t + 1 ).bandwidth,l = u.getTrackForQuality( t ).bandwidth,i = k / l,g >= i)
                    if (g > 100)
                        p.debug.log( "Tons of bandwidth available, go all the way up." ),o = new MediaPlayer.rules.SwitchRequest( n - 1 );
                    else if (g > 10)
                        p.debug.log( "Just enough bandwidth available, switch up one." ),o = new MediaPlayer.rules.SwitchRequest( t + 1 );
                    else {
                        for (m = - 1;
                            (m += 1) < n && !(g < b.call(p,u,m,l));)
                            ;
                        p.debug.log( "Calculated ideal new quality index is: " + m ),o = new MediaPlayer.rules.SwitchRequest( m )
                    }
                else
                    o = new MediaPlayer.rules.SwitchRequest;
            else
                o = new MediaPlayer.rules.SwitchRequest( n );
            d( o )
        },
        reset : function () {
            a = {}
    ...
    return{
        ...
        execute : function (c,d) {
            var e,
                f,
                g = this,
                h = c.getMediaInfo().type,
                i = c.getCurrentValue(),
                j = g.metricsModel.getReadOnlyMetricsFor( h ),
                k = !1,
                l = MediaPlayer.rules.SwitchRequest.prototype.DEFAULT;
            return null === j.PlayList || void 0 === j.PlayList || 0 === j.PlayList.length ? void d( new MediaPlayer.rules.SwitchRequest ) : (e = j.PlayList[j.PlayList.length - 1],null === e || void 0 === e || 0 === e.trace.length ? void d( new MediaPlayer.rules.SwitchRequest ) : (f = e.trace[e.trace.length - 2],null === f || void 0 === f || null === f.stopreason || void 0 === f.stopreason ? void d( new MediaPlayer.rules.SwitchRequest ) : (f.stopreason === MediaPlayer.vo.metrics.PlayList.Trace.REBUFFERING_REASON && (k = !0,a += 1,g.debug.log( "Number of times the buffer has run dry: " + a )),a > b && (l = MediaPlayer.rules.SwitchRequest.prototype.STRONG,g.debug.log( "Apply STRONG to buffer rule." )),void(k ? (g.debug.log( "The buffer ran dry recently, switch down." ),d( new MediaPlayer.rules.SwitchRequest( i - 1,l ) )) : a > b ? (g.debug.log( "Too many dry buffer hits, quit switching bitrates." ),d( new MediaPlayer.rules.SwitchRequest( i,l ) )) : d( new MediaPlayer.rules.SwitchRequest( MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE,l ) )))))
        }
    }
...
MediaPlayer.rules.LimitSwitchesRule = function () {
    ...
    return{
        ...
        execute : function (c,d) {
            var e,
                f = this,
                g = c.getMediaInfo().type,
                h = c.getCurrentValue(),
                i = this.metricsModel.getReadOnlyMetricsFor( g ),
                j = c.getManifestInfo(),
                k = i.RepSwitchList.length - 1,
                l = i.RepSwitchList[k],
                m = (new Date).getTime();
            return b = 1e3 * Math.min( j.minBufferTime,j.maxFragmentDuration ),e = m - a,b > e && m - l.t.getTime() < b ? (f.debug.log( "Wait some time before allowing another switch." ),void d( new MediaPlayer.rules.SwitchRequest( h,MediaPlayer.rules.SwitchRequest.prototype.STRONG ) )) : (a = m,void d( new MediaPlayer.rules.SwitchRequest( MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE,MediaPlayer.rules.SwitchRequest.prototype.STRONG ) ))
        }
    }
...
MediaPlayer.rules.BufferLevelRule = function () {
    ...
    var a = {},
        ...
        e = function (a,b) {
            var c;
            return c = isNaN( b ) || MediaPlayer.dependencies.BufferController.DEFAULT_MIN_BUFFER_TIME < b && b > a ? Math.max( MediaPlayer.dependencies.BufferController.DEFAULT_MIN_BUFFER_TIME,a ) : a >= b ? Math.min( b,MediaPlayer.dependencies.BufferController.DEFAULT_MIN_BUFFER_TIME ) : Math.min( b,a )
        },
        f = function (a,b,c) {
            var f = this,
                g = c.bufferController.getCriticalBufferLevel(),
                h = e.call( this,c.bufferController.getMinBufferTime(),b ),
                i = h,
                j = c.bufferController.bufferMax,
                k = f.metricsModel.getReadOnlyMetricsFor( "video" ),
                l = f.metricsModel.getReadOnlyMetricsFor( "audio" ),
                m = b >= MediaPlayer.dependencies.BufferController.LONG_FORM_CONTENT_DURATION_THRESHOLD,
                n = 0;
            return j === MediaPlayer.dependencies.BufferController.BUFFER_SIZE_MIN ? n = h : j === MediaPlayer.dependencies.BufferController.BUFFER_SIZE_INFINITY ? n = b : j === MediaPlayer.dependencies.BufferController.BUFFER_SIZE_REQUIRED && (!a && f.abrController.isPlayingAtTopQuality() && (i = m ? MediaPlayer.dependencies.BufferController.BUFFER_TIME_AT_TOP_QUALITY_LONG_FORM : MediaPlayer.dependencies.BufferController.BUFFER_TIME_AT_TOP_QUALITY),n = i + Math.max( d.call( f,k ),d.call( f,l ) )),n = Math.min( n,g )
        },
        g = function (a,c) {
            return b[a] && b[a][c]
        },
        ...
        i = function (a,c,d) {
            var e = c.getContext().streamProcessor.getStreamInfo().id;
            b[e] = b[e] || {},b[e][d.mediaType] = !0
        },
        j = function (b) {
            var c = b.streamProcessor.getStreamInfo().id;
            a[c] = a[c] || {},a[c][b.streamProcessor.getType()] = !0
        },
        k = function (b) {
            var c = b.streamProcessor.getStreamInfo().id;
            a[c] = a[c] || {},a[c][b.streamProcessor.getType()] = !1
        };
    return{
        metricsExt : void 0,
        metricsModel : void 0,
        abrController : void 0,
        setup : function () {
            this.bufferLevelOutrun = j,this.bufferLevelBalanced = k,this.streamCompleted = i
        },
        ...
        execute : function (a,b) {
            var d = a.getStreamInfo(),
                e = d.id,
                i = a.getMediaInfo().type;
            if (h( e,i ))
                return void b( new MediaPlayer.rules.SwitchRequest( 0,MediaPlayer.rules.SwitchRequest.prototype.STRONG ) );
            var j,
                k = this.metricsModel.getReadOnlyMetricsFor( i ),
                l = this.metricsExt.getCurrentBufferLevel( k ) ? this.metricsExt.getCurrentBufferLevel( k ).level : 0,
                m = c[e][i],
                n = m.streamProcessor.getCurrentTrack(),
                o = m.streamProcessor.isDynamic(),
                p = this.metricsExt.getCurrentPlaybackRate( k ),
                q = d.duration,
                r = l / Math.max( p,1 ),
                s = n.fragmentDuration,
                t = m.playbackController.getTime(),
                u = o ? Number.POSITIVE_INFINITY : q - t,
                v = Math.min( f.call( this,o,q,m ),u ),
                w = Math.max( v - r,0 );
            j = Math.ceil( w / s ),r >= u && !g( e,i ) && (j = j || 1),b( new MediaPlayer.rules.SwitchRequest( j,MediaPlayer.rules.SwitchRequest.prototype.DEFAULT ) )
        },
        reset : function () {
            a = {},b = {},c = {}
        }
...
MediaPlayer.rules.LiveEdgeBinarySearchRule = function () {
    ...
    var a,
        ...
        h = !1,
        i = 0 / 0,
        j = MediaPlayer.rules.SwitchRequest.prototype.DEFAULT,
        k = function (b,c,d,e) {
            var f,
                h = this;
            if (null === e)
                f = h.adapter.generateFragmentRequestForTime( a.streamProcessor,g,b ),k.call( h,b,c,d,f );
            else {
                var i = function (e,f,g) {
                    a.fragmentLoader.unsubscribe( a.fragmentLoader.eventList.ENAME_CHECK_FOR_EXISTENCE_COMPLETED,h,i ),f ? c.call( h,g,b ) : d.call( h,g,b )
                };
                a.fragmentLoader.subscribe( a.fragmentLoader.eventList.ENAME_CHECK_FOR_EXISTENCE_COMPLETED,h,i ),a.fragmentLoader.checkForExistence( e )
            }
        },
        l = function (c,i) {
            var o,
                p,
                q;
            return h ? void n.call( this,!1,i ) : (q = i - d,o = q > 0 ? d - q : d + Math.abs( q ) + f,void(o < e.start && o > e.end ? b( new MediaPlayer.rules.SwitchRequest( null,j ) ) : (p = this.adapter.getFragmentRequestForTime( a.streamProcessor,g,o ),k.call( this,o,m,l,p ))))
        },
        m = function (c,l) {
            var m,
                o,
                ...
                q = this;
            if (!h) {
                if (!g.fragmentDuration)
                    return void b( new MediaPlayer.rules.SwitchRequest( p,j ) );
                if (h = !0,e.end = p + 2 * f,l === d)
                    return o = l + i,m = q.adapter.getFragmentRequestForTime( a.streamProcessor,g,o ),void k.call( q,o,function () {
                        n.call( q,!0,o )
                    },function () {
        ...
        n = function (c,d) {
            var f,
                h,
                n;
            c ? e.start = d : e.end = d,f = Math.floor( e.end - e.start ) <= i,f ? b( new MediaPlayer.rules.SwitchRequest( c ? d : d - i,j ) ) : (n = (e.start + e.end) / 2,h = this.adapter.getFragmentRequestForTime( a.streamProcessor,g,n ),k.call( this,n,m,l,h ))
        };
    return{
        metricsExt : void 0,
        adapter : void 0,
        ...
        execute : function (h,n) {
            var o,
                p,
                q = this;
            return b = n,g = a.streamProcessor.getCurrentTrack(),i = g.fragmentDuration,p = g.DVRWindow,d = p.end,g.useCalculatedLiveEdgeTime ? void b( new MediaPlayer.rules.SwitchRequest( d,j ) ) : (e = {
                start : Math.max( 0,d - c ),
                end : d + c
            },
            f = Math.floor( (p.end - p.start) / 2 ),o = q.adapter.getFragmentRequestForTime( a.streamProcessor,g,d ),void k.call( q,d,m,l,o ))
        },
        reset : function () {
    ...
    return{
        ...
        execute : function (c,d) {
            var e = c.getMediaInfo().type,
                ...
                j = i.getPendingRequests(),
                k = i.getLoadingRequests(),
                l = i.getRejectedRequests(),
                m = l.length,
                n = j.length + k.length,
                o = Math.max( g - n,0 );
            return m > 0 ? void d( new MediaPlayer.rules.SwitchRequest( m,MediaPlayer.rules.SwitchRequest.prototype.DEFAULT ) ) : n > a ? void d( new MediaPlayer.rules.SwitchRequest( 0,MediaPlayer.rules.SwitchRequest.prototype.DEFAULT ) ) : 0 === g ? void d( new MediaPlayer.rules.SwitchRequest( o,MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE ) ) : void d( new MediaPlayer.rules.SwitchRequest( o,MediaPlayer.rules.SwitchRequest.prototype.DEFAULT ) )
        },
        reset : function () {
            b = {}
        }
...
MediaPlayer.rules.PlaybackTimeRule = function () {
    ...
    var a = {},
        ...
        c = function (b,c) {
            var d = b.getStreamId();
            a[d] = a[d] || {},a[d].audio = c,a[d].video = c
        };
    return{
        adapter : void 0,
        sourceBufferExt : void 0,
        ...
        execute : function (c,d) {
            var e,
                ...
                g,
                h = c.getMediaInfo().type,
                i = c.getStreamInfo().id,
                j = b[i][h],
                k = b[i][h].streamProcessor,
                l = k.getCurrentTrack(),
                m = a[i] ? a[i][h] : null,
                n = m ? MediaPlayer.rules.SwitchRequest.prototype.STRONG : MediaPlayer.rules.SwitchRequest.prototype.DEFAULT,
                o = j.getFragmentModel().getRejectedRequests().shift(),
                p = !!o && !m,
                q = this.adapter.getIndexHandlerTime( k ),
                r = k.playbackController.getTime(),
                s = o ? o.startTime + o.duration : null,
                t = o && (s > r && o.startTime <= q || isNaN( q ));
            if (f = m || (t ? o.startTime : q),isNaN( f ))
                return void d( new MediaPlayer.rules.SwitchRequest( null,n ) );
            for (a[i] && (a[i][h] = null),e = this.sourceBufferExt.getBufferRange( k.bufferController.getBuffer(),f ),null !== e && (f = e.end),g = this.adapter.getFragmentRequestForTime( k,l,f,p ),t && g && g.index !== o.index && (g = this.adapter.getFragmentRequestForTime( k,l,o.startTime + o.duration / 2,p ));
                g && k.fragmentController.isFragmentLoadedOrPending( j,g );) {
                if ("complete" === g.action) {
                    g = null,this.adapter.setIndexHandlerTime( k,0 / 0 );
                    break
                }
                g = this.adapter.getNextFragmentRequest( k,l )
            }
            g && !t && this.adapter.setIndexHandlerTime( k,g.startTime + g.duration ),d( new MediaPlayer.rules.SwitchRequest( g,n ) )
        },
        reset : function () {
            a = {},b = {}
        }
            ...
            for (g in b)
                if (i = b[g],j = i.length)
                    for (k = 0;
                        j > k;
                        k += 1)
                        e = i[k],d.call( this,e ) && (e = f.call( this,e ),h = a.getRules( g ),c && (h.length = 0),h.push( e ))
        };
    return{
        system : void 0,
        debug : void 0,
        ...
        applyRules : function (a,b,c,f,g) {
            ...
            for (l[MediaPlayer.rules.SwitchRequest.prototype.STRONG] = MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE,l[MediaPlayer.rules.SwitchRequest.prototype.WEAK] = MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE,l[MediaPlayer.rules.SwitchRequest.prototype.DEFAULT] = MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE,i = 0;
                k > i;
                i += 1)
                h = a[i],d.call( this,h ) ? h.execute( m,n ) : j--
        },
        reset : function () {
            a = {}
        }
    ...
    var a = 4,
        b = function (a,b) {
            ...
            for (i;
                j > i;
                i += 1)
                for (f = a[i].getPendingRequests(),d.call( this,f,"index" ),g = 0,h = f.length;
                    h > g;
                    g++) {
        ...
        c = function (a,b) {
            ...
            for (d = 0;
                e > d;
                d += 1)
                c = a[d].getPendingRequestForTime( b ),c && (!f || c.startTime > f.startTime) && (f = c);
            return f
        },
        d = function (a,b) {
            var c = function (a,c) {
    ...
    return{
        ...
        execute : function (d,e) {
            var f,
                ...
                m,
                n,
                o = d.getStreamInfo().id,
                p = d.getCurrentValue(),
                q = MediaPlayer.rules.SwitchRequest.prototype.DEFAULT,
                r = this.fragmentModels[o],
                s = new Date,
                t = null,
                u = r ? r.length : null,
                v = !1,
            ...
            if (!r || !u)
                return void e( new MediaPlayer.rules.SwitchRequest( [
                ],q ) );
            if (k = Math.round( 100 * r[0].getContext().playbackController.getTime() ) / 100,l = c( r,k ),j = l || b( r,k ) || p,!j)
                return void e( new MediaPlayer.rules.SwitchRequest( [
                ],q ) );
            for (i = 0;
                u > i;
                i += 1)
                if (g = r[i],f = g.getContext().streamProcessor.getType(),("video" === f || "audio" === f) && (m = g.getPendingRequests(),n = g.getLoadingRequests().length,!g.getIsPostponed() || isNaN( j.startTime ))) {
                    if (n > a)
                        return void e( new MediaPlayer.rules.SwitchRequest( [
                        ],q ) );
                    if (t = t || (j === l ? k : j.startTime),-1 === m.indexOf( j )) {
                        if (h = g.getPendingRequestForTime( t ))
                            w.push( h );
                        else if (h = g.getLoadingRequestForTime( t ) || g.getExecutedRequestForTime( t ),!h) {
                            v = !0;
                            break
                        }
                    }else
            ...
            } ),v ? void e( new MediaPlayer.rules.SwitchRequest( [
            ],q ) ) : void e( new MediaPlayer.rules.SwitchRequest( w,q ) )
        }
    }
...
MediaPlayer.vo.FragmentRequest = function () {
    "use strict";
    this.action = "download",this.startTime = 0 / 0,this.mediaType = null,this.type = null,this.duration = 0 / 0,this.timescale = 0 / 0,this.range = null,this.url = null,this.requestStartDate = null,this.firstByteDate = null,this.requestEndDate = null,this.quality = 0 / 0,this.index = 0 / 0,this.availabilityStartTime = null,this.availabilityEndTime = null,this.wallStartTime = null
...
MediaPlayer.vo.ManifestInfo = function () {
    "use strict";
    this.DVRWindowSize = 0 / 0,this.loadedTime = null,this.availableFrom = null,this.minBufferTime = 0 / 0,this.duration = 0 / 0,this.isDynamic = !1,this.maxFragmentDuration = null
},MediaPlayer.vo.ManifestInfo.prototype = {
    constructor : MediaPlayer.vo.ManifestInfo
},
MediaPlayer.vo.MediaInfo = function () {
    "use strict";
    this.id = null,this.index = null,this.type = null,this.streamInfo = null,this.trackCount = 0,this.lang = null,this.codec = null,this.mimeType = null,this.contentProtection = null,this.isText = !1,this.KID = null
...
MediaPlayer.vo.metrics.ManifestUpdate = function () {
    "use strict";
    this.mediaType = null,this.type = null,this.requestTime = null,this.fetchTime = null,this.availabilityStartTime = null,this.presentationStartTime = 0,this.clientTimeOffset = 0,this.currentTime = null,this.buffered = null,this.latency = 0,this.streamInfo = [
    ],this.trackInfo = [
    ]
