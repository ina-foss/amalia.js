...
(function (a,b) {
        ...
        return function (b,c) {
            ...
            if (p.isFunction( c ))
                for (;
                    h < i;
                    h++)
                    d = g[h],f = /^\+/.test( d ),f && (d = d.substr( 1 ) || "*"),e = a[d] = a[d] || [
                    ],e[f ? "unshift" : "push"]( c )
        }
    }
    ...
    function cY(a,b,c) {
        ...
        c.queue || (j = p._queueHooks( a,"fx" ),j.unqueued == null && (j.unqueued = 0,k = j.empty.fire,j.empty.fire = function () {
            ...
            m.overflowX,
            m.overflowY
        ],p.css( a,"display" ) === "inline" && p.css( a,"float" ) === "none" && (!p.support.inlineBlockNeedsLayout || cc( a.nodeName ) === "inline" ? m.display = "inline-block" : m.zoom = 1)),c.overflow && (m.overflow = "hidden",p.support.shrinkWrapBlocks || l.done( function () {
    ...
    p.Callbacks = function (a) {
        ...
        var c,
            ...
            k = function (b) {
                ...
                e = !1,i && (j ? j.length && k( j.shift() ) : c ? i = [
                ] : l.disable())
            },
            l = {
                add : function () {
    ...
    p.extend( {
        ...
        removeData : function (a,b,c) {
            ...
            g ? p.cleanData( [
                a
            ],!0 ) : p.support.deleteExpando || h != h.window ? delete h[i] : h[i] = null
        },
        ...
        data : function (a,c) {
            ...
            return typeof a == "object" ? this.each( function () {
                ...
                if (c === b)
                    return k = this.triggerHandler( "getData" + e,[
                        d[0]
                    ] ),k === b && i && (k = p.data( i,a ),k = J( i,a,k )),k === b && d[1] ? this.data( d[0] ) : k;
    ...
    }),p.support.hrefNormalized || p.each( [
        "href",
        "src",
        "width",
        "height"
    ...
    p.event = {
        add : function (a,c,d,e,f) {
            ...
            for (j = 0;
                ...
                j++) {
                k = W.exec( c[j] ) || [
                ],l = k[1],m = (k[2] || "").split( "." ).sort(),r = p.event.special[l] || {},l = (f ? r.delegateType : r.bindType) || l,r = p.event.special[l] || {},n = p.extend( {
                    type : l,
                    origType : k[1],
                    data : e,
                    handler : d,
        ...
        trigger : function (c,d,f,g) {
            if (!f || f.nodeType !== 3 && f.nodeType !== 8) {
                ...
                c.result = b,c.target || (c.target = f),d = d != null ? p.makeArray( d ) : [
                ],d.unshift( c ),n = p.event.special[s] || {};
                ...
                if (!g && !n.noBubble && !p.isWindow( f )) {
                    ...
                    l === (f.ownerDocument || e) && q.push( [
                        l.defaultView || l.parentWindow || a,
                        r
                    ] )
                }
                for (j = 0;
                ...
                for (f = c.target;
                    ...
                    if (f.disabled !== !0 || c.type !== "click") {
                        ...
                        for (d = 0;
                            d < q;
                            d++)
                            l = o[d],m = l.selector,h[m] === b && (h[m] = l.needsContext ? p( m,this ).index( f ) >= 0 : p.find( m,this,null,[
                                f
                            ] ).length),h[m] && j.push( l );
                        j.length && u.push( {
                            elem : f,
    ...
    p.each( {
        ...
        j = s.compareDocumentPosition ? function (a,b) {
            ...
            0,
            0
        ].sort( j ),m = !k,bc.uniqueSort = function (a) {
            var b,
                c = 1;
            k = m,a.sort( j );
            if (k)
    ...
    p.fn.extend( {
        ...
        filter : function (a,b,c) {
            return c && (a = ":not(" + a + ")"),b.length === 1 ? p.find.matchesSelector( b[0],a ) ? [
                b[0]
            ] : [
            ] : p.find.matches( a,b )
        },
    ...
    bz.optgroup = bz.option,bz.tbody = bz.tfoot = bz.colgroup = bz.caption = bz.thead,bz.th = bz.td,p.support.htmlSerialize || (bz._default = [
        1,
        "X<div>",
        "</div>"
    ]),p.fn.extend( {
        ...
        remove : function (a,b) {
            ...
            for (;
                ...
                if (!a || p.filter( a,[
                    ...
                    !b && c.nodeType === 1 && (p.cleanData( c.getElementsByTagName( "*" ) ),p.cleanData( [
                        c
            ...
            if (c) {
                ...
                for (f = 0;
                    ...
                    if (!p.nodeName( h,"script" ) || !q( h ))
                        c.appendChild( h ),typeof h.getElementsByTagName != "undefined" && (r = p.grep( p.merge( [
                        ],h.getElementsByTagName( "script" ) ),q ),t.splice.apply( t,[
                            f + 1,
                            0
                        ].concat( r ) ),f += r.length)
            }
    ...
    p.fn.extend( {
        ...
        }),!p.support.pixelPosition && p.fn.position && p.each( [
            "top",
            "left"
        ],function (a,b) {
            p.cssHooks[b] = {
    ...
    cj = ct.exec( ck.toLowerCase() ) || [
        ...
        ajax : function (a,c) {
            function y(a,c,f,i) {
                ...
                x.status = a,x.statusText = (c || y) + "",k ? o.resolveWith( m,[
                    s,
                    y,
                    x
                ] ) : o.rejectWith( m,[
                    ...
                    y,
                    t
                ] ),x.statusCode( r ),r = b,j && n.trigger( "ajax" + (k ? "Success" : "Error"),[
                    x,
                    l,
                    k ? s : t
                ] ),q.fireWith( m,[
            ...
            if (!l.beforeSend || l.beforeSend.call( m,x,l ) !== !1 && v !== 2) {
                ...
                if (!g)
                    ...
                    x.readyState = 1,j && n.trigger( "ajaxSend",[
                        x,
                        l
    ...
    p.timers = [
    ],p.fx = cZ.prototype.init,p.fx.tick = function () {
        var a,
            b = p.timers,
            c = 0;
        for (;
