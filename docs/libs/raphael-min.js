...
!function (a) {
    ...
    k._events = j,k.listeners = function (a) {
        ...
        for (e = 0,h = m.length;
            h > e;
            e++) {
            for (l = [],i = 0,k = o.length;
                k > i;
                i++)
                for (n = o[i].n,c = [n[m[e]],n[g]],d = 2;
                    d--;)
        ...
        for (var e,
            ...
            if ("M" == s[0])
                ...
                "C" == s[0] ? (n = [
                    e,
                    f
                ].concat( s.slice( 1 ) ),e = n[6],f = n[7]) : (n = [
                    e,
                    f,
                    e,
                    f,
                ...
                for (var t = 0,
                    ...
                    if ("M" == v[0])
                        ...
                        "C" == v[0] ? (o = [
                            g,
                            h
                        ].concat( v.slice( 1 ) ),g = o[6],h = o[7]) : (o = [
                            g,
                            h,
                            g,
                            h,
                        ...
                        switch (r[y] = d.attr( y ),null == r[y] && (r[y] = cb[y]),s[y] = i[y],db[y]) {
                            ...
                            case"transform":
                                ...
                                if (H)
                                    for (r[y] = H.from,s[y] = H.to,t[y] = [],t[y].real = !0,v = 0,x = r[y].length;
                                        x > v;
                                        v++)
                                        for (t[y][v] = [r[y][v][0]],D = 1,F = r[y][v].length;
                                            F > D;
                                            D++)
                                    ...
                                    r[y] = [
                                        ...
                                        K.e,
                                        K.f
                                    ],Nb( L,s[y] ),s[y] = L._.transform,t[y] = [
                                        (L.matrix.a - K.a) / p,
                                        (L.matrix.b - K.b) / p,
                                        (L.matrix.c - K.c) / p,
                                        (L.matrix.d - K.d) / p,
                            ...
                            case"csv":
                                var M = I( i[y] )[J]( w ),
                                    N = I( r[y] )[J]( w );
                                if ("clip-rect" == y)
                                    for (r[y] = N,t[y] = [],v = N.length;
                                        v--;)
                                        t[y][v] = (M[v] - r[y][v]) / p;
                                s[y] = M;
                                break;
                            default:
                            for (M = [][E](i[y]),N = [][E](r[y]),t[y] = [],v = d.paper.customAttributes[y].length;
                                v--;)
                                t[y][v] = ((M[v] || 0) - (N[v] || 0)) / p
                        }
                var O = i.easing,
    ...
    rb = c.mapPath = function (a,b) {
        ...
        var c,
            ...
            h,
            i;
        for (a = Kb(a),e = 0,g = a.length;
            g > e;
            e++)
            for (i = a[e],f = 1,h = i.length;
                h > f;
                f += 2)
    ...
    var ub = function (a) {
        ...
        yb = function (a,b,d) {
            ...
            return(a > 1 || b > 1 || d > 1) && (a /= 255,b /= 255,d /= 255),[
                a,
                b,
                d
            ]
    ...
    c.color = function (a) {
        ...
        var e,
            ...
            h,
            i;
        return a = a % 360 / 60,i = c * b,h = i * (1 - Q( a % 2 - 1 )),e = f = g = c - i,a = ~~a,e += [
            i,
            h,
            0,
            0,
        ...
        var e,
            ...
            h,
            i;
        return a = a % 360 / 60,i = 2 * b * (.5 > c ? c : 1 - c),h = i * (1 - Q( a % 2 - 1 )),e = f = g = c - i / 2,a = ~~a,e += [
            i,
            h,
            0,
            0,
    ...
    c.getRGB = f( function (a) {
        ...
        return c.is( a,V ) && c.is( a[0],V ) && (e = Cb( a )),e.length || I( a ).replace( hb,function (a,b,c) {
            ...
            if (c.replace( jb,function (a,b) {
                b && f.push( +b )
            } ),"m" == g && f.length > 2 && (e.push( [
                b
            ][E]( f.splice( 0,2 ) ) ),g = "l",b = "m" == b ? "l" : "L"),"r" == g)
                e.push( [
                    b
                ][E]( f ) );
            else
    ...
    var Bb = c.pathBBox = function (a) {
        ...
        Db = c._pathToRelative = function (a) {
            ...
            var d = [
                ...
                h = 0,
                i = 0;
            "M" == a[0][0] && (e = a[0][1],f = a[0][2],g = e,h = f,i++,d.push( [
                "M",
                e,
                f
            ] ));
        ...
        Eb = c._pathToAbsolute = function (a) {
            ...
            var d = [
                ...
                i = 0,
                j = 0;
            "M" == a[0][0] && (e = +a[0][1],f = +a[0][2],g = e,i = f,j++,d[0] = [
                "M",
                e,
                f
            ]);
            for (var k,
                ...
                if (d.push( k = [
                    ...
                    p = [
                        e,
                        f
                    ][E]( l.slice( 1 ) ),d.pop(),d = d[E]( h( p,m ) ),k = [
                        "R"
                    ][E]( l.slice( -2 ) );
                else
                    for (var s = 0,
        ...
        Hb = function (a,b,c,d,e,g,h,i,j,k) {
            ...
            if (Q( A ) > m) {
                var B = z,
                    C = i,
                    D = j;
                z = y + m * (h && z > y ? 1 : -1),i = w + c * N.cos( z ),j = x + d * N.sin( z ),o = Hb( i,j,c,d,e,0,h,C,D,[
                    z,
                    B,
                    w,
                    x
            ...
            h = (function (a,b,c) {
                ...
                switch (!(a[0]in f) && (b.qx = b.qy = null),a[0]) {
                    ...
                    case"S":
                        ...
                        break;
                    case"T":
                        "Q" == c || "T" == c ? (b.qx = 2 * b.x - b.qx,b.qy = 2 * b.y - b.qy) : (b.qx = b.x,b.qy = b.y),a = [
                            "C"
                        ][E]( Gb( b.x,b.y,b.qx,b.qy,a[1],a[2] ) );
                        break;
                    case"Q":
                        b.qx = a[1],b.qy = a[2],a = [
                            "C"
                        ][E]( Gb( b.x,b.y,a[1],a[2],a[3],a[4] ) );
                        break;
                    case"L":
                        a = [
                            "C"
                        ][E]( Fb( b.x,b.y,a[1],a[2] ) );
                        break;
                    case"H":
                        a = [
                            "C"
                        ][E]( Fb( b.x,b.y,a[1],b.y ) );
                        break;
                    case"V":
                        a = [
                            "C"
                        ][E]( Fb( b.x,b.y,b.x,a[1] ) );
                        break;
                    case"Z":
                        a = [
                            "C"
                        ][E]( Fb( b.x,b.y,b.X,b.Y ) )
                }
                return a
            }),
                i = function (a,b) {
                ...
                j = function (a,b,c,f,g) {
                    a && b && "M" == a[g][0] && "M" != b[g][0] && (b.splice( g,0,[
                        "M",
                        f.x,
                        f.y
        ...
        Lb = (c._parseDots = f( function (a) {
            ...
            for (d = 1,e = b.length - 1;
                e > d;
                d++)
                if (!b[d].offset) {
                    for (var h = _( b[d - 1].offset || 0 ),
                        i = 0,
                        j = d + 1;
                        e > j;
                        j++)
        ...
        Pb = c._equaliseTransform = function (a,b) {
            b = I( b ).replace( /\.{3}|\u2026/g,a ),a = c.parseTransformString( a ) || [
    ...
    c._getContainer = function (a,b,d,e) {
        ...
        a.add = function (a,b,c,d,e,f) {
            ...
            for (a && a instanceof o && (m = [[a.a,a.c,a.e],[a.b,a.d,a.f],[0,0,1]]),g = 0;
                3 > g;
                g++)
                for (h = 0;
                    3 > h;
            ...
            a.scalex = N.sqrt( b( e[0] ) ),d( e[0] ),a.shear = e[0][0] * e[1][0] + e[0][1] * e[1][1],e[1] = [
                e[1][0] - e[0][0] * a.shear,
                e[1][1] - e[0][1] * a.shear
            ],a.scaley = N.sqrt( b( e[1] ) ),d( e[1] ),a.shear /= a.scaley;
            var f = -e[0][1],
                g = e[1][1];
            ...
            var b = a || this[J]();
            return b.isSimple ? (b.scalex = +b.scalex.toFixed( 4 ),b.scaley = +b.scaley.toFixed( 4 ),b.rotate = +b.rotate.toFixed( 4 ),(b.dx || b.dy ? "t" + [
                b.dx,
                b.dy
            ] : G) + (1 != b.scalex || 1 != b.scaley ? "s" + [
                b.scalex,
                b.scaley,
                0,
                0
    ...
    v.getElementByPoint = function (a,b) {
        ...
        if (!e)
            return null;
        for (;
            e.parentNode && e != d.parentNode && !e.raphael;)
            e = e.parentNode;
                            ...
                            for (var r in k)
                                if (k[z]( r )) {
                                    switch (db[r]) {
                                        ...
                                        case"transform":
                                            if (l[r].real)
                                                for (f = [],t = 0,u = k[r].length;
                                                    u > t;
                                                    t++)
                                                    for (f[t] = [k[r][t][0]],v = 1,w = k[r][t].length;
                                                        w > v;
                                                        v++)
                                                        f[t][v] = k[r][t][v] + q * i * l[r][t][v];
                                            else {
                                        ...
                                        default:
                                            ...
                                            for (f = [],t = n.paper.customAttributes[r].length;
                                                t--;)
                                                f[t] = +y[t] + q * i * l[r][t]
                                    }
                                    o[r] = f
    ...
    $b.animateWith = function (a,b,d,e,f,g) {
        ...
        if (f)
            return d && (h.easing = d),e && (h.callback = e),new r( {
                100 : h
            },b );
        if (e) {
            var i = 0;
    ...
    return nc.attr = function (a,b) {
        ...
        for (c = this.items.length = this.length -= b - g;
            this[c];)
            delete this[c++];
        return new mc( e )
        ...
        if (this.fonts[c] ? this.fonts[c].push( b ) : this.fonts[c] = [
            b
        ],!a.svg) {
        ...
        if (e = e || "normal",d = d || "normal",b = +b || {
            ...
            if (f)
                for (var j = 0,
                    k = f.length;
                    k > j && (i = f[j],i.face["font-weight"] != b || i.face["font-style"] != d && i.face["font-style"] || i.face["font-stretch"] != e);
                    j++)
                    ;
            return i
        }
                ...
                y = function (d,f) {
                    if ("text" == d.type && (f[a]( "text" ) || f[a]( "font" ) || f[a]( "font-size" ) || f[a]( "x" ) || f[a]( "y" ))) {
                        ...
                        if (f[a]( "text" )) {
                            ...
                            for (m = h.getElementsByTagName("tspan"),n = 0,o = m.length;
                                o > n;
                                n++)
                                n ? q( m[n],{
                                    dy : i * x,
            ...
            Element = function (a,b) {
                ...
                for (n in this.paper.customAttributes)
                    if (this.paper.customAttributes[a]( n ) && m[a]( n ) && c.is( this.paper.customAttributes[n],"function" )) {
                        var o = this.paper.customAttributes[n].apply( this,[
                        ].concat( m[n] ) );
                        this.attrs[n] = m[n];
                        for (var p in o)
                            o[a]( p ) && (m[p] = o[p])
                ...
                k( "raphael.setViewBox",this,this._viewBox,[
                    a,
                    b,
                    c,
                    d,
                ...
                for (null == a?(this._vbSize && (j = 1),delete this._vbSize,f = "0 0 " + this.width + m + this.height):(this._vbSize = j,f = a + m + b + m + c + m + d),q(this.canvas,{viewBox:f,preserveAspectRatio:n});
                    j && l;)
                    h = "stroke-width"in l.attrs ? l.attrs["stroke-width"] : 1,l.attr( {
                        "stroke-width" : h
        ...
        if (c.vml) {
            ...
            var A = function (a,c,d) {
                ...
                B = function (e,i) {
                    ...
                    for (var t in i)
                        i[a]( t ) && (m[t] = i[t]);
                    if (q && (m.path = c._getPath[e.type]( e ),e._.dirty = 1),i.href && (l.href = i.href),i.title && (l.title = i.title),i.target && (l.target = i.target),i.cursor && (p.cursor = i.cursor),"blur"in i && e.blur( i.blur ),(i.path && "path" == e.type || q) && (l.path = x( ~b( m.path ).toLowerCase().indexOf( "r" ) ? c._pathToAbsolute( m.path ) : m.path ),e._.dirty = 1,"image" == e.type && (e._.fillpos = [
                        m.x,
                        m.y
                    ],e._.fillsize = [
                        m.width,
                    ...
                    if ("arrow-start"in i && A( s,i["arrow-start"] ),"arrow-end"in i && A( s,i["arrow-end"],1 ),null != i.opacity || null != i["stroke-width"] || null != i.fill || null != i.src || null != i.stroke || null != i["stroke-width"] || null != i["stroke-opacity"] || null != i["fill-opacity"] || null != i["stroke-dasharray"] || null != i["stroke-miterlimit"] || null != i["stroke-linejoin"] || null != i["stroke-linecap"]) {
                        ...
                        if (K = K && K[0],!K && (L = K = F( j )),"image" == e.type && i.src && (K.src = i.src),i.fill && (K.on = !0),(null == K.on || "none" == i.fill || null === i.fill) && (K.on = !1),K.on && i.fill) {
                            ...
                            if (M) {
                                ...
                                var N = e.getBBox( 1 );
                                K.position = N.x + n + N.y,e._.fillpos = [
                                    N.x,
                                    N.y
            ...
            D.prototype = E,E.constructor = D,E.transform = function (a) {
                ...
                if (n) {
                    for (o in this.paper.customAttributes)
                        if (this.paper.customAttributes[a]( o ) && n[a]( o ) && c.is( this.paper.customAttributes[o],"function" )) {
                            var p = this.paper.customAttributes[o].apply( this,[
                            ].concat( n[o] ) );
                            this.attrs[o] = n[o];
                            for (var q in p)
                                p[a]( q ) && (n[q] = p[q])
                ...
                a && (e.path = a),d.type = "path",d.path = [
                ],d.Path = o,B( d,e ),b.canvas.appendChild( c );
                var f = F( "skew" );
                ...
                return k.src = b,i.X = k.x = d,i.Y = k.y = e,i.W = k.width = f,i.H = k.height = g,k.path = h,i.type = "image",m.parentNode == l && l.removeChild( m ),m.rotate = !0,m.src = b,m.type = "tile",i._.fillpos = [
                    d,
                    e
                ],i._.fillsize = [
                    f,
                    g
                ],l.appendChild( m ),z( i,1,1,0,0,0 ),i
                ...
                c.eve( "raphael.setViewBox",this,this._viewBox,[
                    a,
                    b,
                    d,
                    e,
                ...
                var g,
                    ...
                    j = i.width,
                    k = i.height;
                return f && (g = k / e,h = j / d,j > d * g && (a -= (j - d * g) / 2 / g),k > e * h && (b -= (k - e * h) / 2 / h)),this._viewBox = [
                    a,
                    b,
                    d,
                    e,
